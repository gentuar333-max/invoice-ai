...
// Marketing/SEO pages have their own white Navigation() component inside
// Dashboard navbar must be completely hidden on these pages
...
export default function NavbarClient() {
  ...
  if (marketingPrefixes.some((p) => pathname?.startsWith(p))) return null;
