...
const PAGE_URL = `${BASE_URL}/logiciel-facturation-tours`;
...
const schemaSoftware = { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'InvoiceAgent — Logiciel Facturation Tours', applicationCategory: 'BusinessApplication', operatingSystem: 'Web, SaaS', url: PAGE_URL, offers: { '@type': 'AggregateOffer', lowPrice: '0', highPrice: '49', priceCurrency: 'EUR' }, aggregateRating: { '@type': 'AggregateRating', ratingValue: '4.8', reviewCount: '27' } };
const schemaFAQ = {
  '@context': 'https://schema.org', '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: "Quel logiciel de facturation pour les entreprises à Tours ?", acceptedAnswer: { '@type': 'Answer', text: "InvoiceAgent est un logiciel de facturation IA pour les artisans, PME et freelances de Tours et Indre-et-Loire. Automatise l'extraction des factures par OCR IA, gère la TVA et génère le FEC conforme DGFiP. Gratuit jusqu'à 5 factures/mois." } },
    { '@type': 'Question', name: "Comment gérer ses factures fournisseurs à Tours ?", acceptedAnswer: { '@type': 'Answer', text: "Photographiez vos factures Point P Tours avec votre smartphone. InvoiceAgent extrait fournisseur, montants HT/TTC et TVA en moins de 5 secondes par OCR IA." } },
    { '@type': 'Question', name: "InvoiceAgent fonctionne-t-il pour les artisans de Indre-et-Loire ?", acceptedAnswer: { '@type': 'Answer', text: "Oui. Accessible depuis smartphone ou ordinateur, sans installation. Les artisans de Indre-et-Loire scannent leurs factures depuis le chantier et exportent leur FEC pour leur comptable local." } },
  ],
};
const schemaBreadcrumb = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Accueil', item: BASE_URL }, { '@type': 'ListItem', position: 2, name: 'Logiciel Facturation Tours', item: PAGE_URL }] };
const schemaLocal = { '@context': 'https://schema.org', '@type': 'LocalBusiness', name: 'InvoiceAgent — Tours', url: PAGE_URL, description: 'Logiciel de facturation IA pour artisans et PME à Tours', areaServed: { '@type': 'City', name: 'Tours' } };
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="text-center lg:text-left">
            <motion.div variants={fadeInUp}>
              <Badge className="mb-6 px-4 py-2 bg-violet-100 text-violet-700 border-0 text-sm font-medium">
                <MapPin className="w-4 h-4 mr-2" />Logiciel de facturation pour artisans et PME à Tours
              </Badge>
            </motion.div>
            <motion.h1 variants={fadeInUp} className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              ...
              <span className="bg-gradient-to-r from-violet-600 via-indigo-600 to-violet-600 bg-clip-text text-transparent">Tours</span><br />
            ...
            <motion.p variants={fadeInUp} className="text-lg sm:text-xl text-slate-600 mb-6 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Plus de <strong>7,400 artisans et 5,800 PME</strong> en Indre-et-Loire gèrent des dizaines de factures fournisseurs chaque mois. InvoiceAgent les traite automatiquement par OCR IA — depuis n'importe quel chantier ou bureau à Tours.
            </motion.p>
            <motion.div variants={fadeInUp} className="grid grid-cols-3 gap-3 mb-8">
              {[{ value: '7,400', label: 'Artisans', sub: 'en Indre-et-Loire' }, { value: '< 5s', label: 'Par facture', sub: 'OCR IA auto' }, { value: '€0', label: 'Pour démarrer', sub: '5 factures/mois' }].map((stat) => (
            ...
            <motion.div variants={fadeInUp} className="bg-indigo-50 border border-indigo-100 rounded-xl p-4 mb-6 text-left">
              <p className="text-sm text-indigo-700 leading-relaxed"><span className="font-semibold">📍 Tours :</span> Située au cœur du Val de Loire, Tours bénéficie d'un tissu artisanal actif lié à la restauration du patrimoine — châteaux, demeures bourgeoises, troglodytes. Les entreprises d'Indre-et-Loire ont des besoins spécifiques en traçabilité des achats matériaux.</p>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="flex flex-wrap items-center justify-center lg:justify-start gap-6 text-sm text-slate-500">
              {["Gratuit jusqu'à 5 factures/mois", "Point P Tours reconnu auto", "Contrats analysés par IA"].map((item) => (
          ...
          <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 1, delay: 0.3 }} className="relative">
            <div className="bg-white rounded-3xl shadow-2xl shadow-violet-600/20 p-6 border border-slate-100">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div><p className="font-semibold text-slate-900">Artisan — Tours</p><p className="text-sm text-slate-500">Indre-et-Loire</p></div>
                </div>
              ...
              <div className="space-y-3">
                {[{ client: 'Point P Tours — Matériaux chantier', amount: '€3,840', status: 'Payée' }, { client: 'Fournisseur local Tours', amount: '€1,280', status: 'En attente' }, { client: 'Point P Tours — Béton', amount: '€2,120', status: 'Payée' }].map((item, i) => (
            ...
            <motion.div animate={{ y: [0, 10, 0] }} transition={{ duration: 4, repeat: Infinity, ease: 'easeInOut', delay: 0.5 }} className="absolute -bottom-4 -left-4 bg-white rounded-2xl shadow-xl p-4 border border-slate-100">
              <div className="flex items-center gap-2"><MapPin className="w-5 h-5 text-violet-500" /><span className="text-sm font-medium text-slate-900">Tours</span><span className="text-xs text-slate-500">37000</span></div>
            </motion.div>
          </motion.div>
        </div>
      </motion.div>
...
function Features() {
  const features = [
    { icon: Zap, title: `OCR factures fournisseurs — Tours`, description: `Scannez vos factures Point P Tours, Brico Dépôt Tours depuis le chantier. Fournisseur, montants HT/TTC, TVA extraits en moins de 5 secondes par OCR IA.`, color: 'from-amber-400 to-orange-500' },
    ...
    { icon: Calculator, title: 'Export FEC conforme DGFiP', description: "Générez votre FEC en un clic. Compatible Sage, EBP, Cegid. Votre expert-comptable de Tours reçoit un fichier structuré.", color: 'from-cyan-400 to-blue-500' },
  ];
  return (
    <section id="features" className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 mb-6">Application facturation <span className="bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-transparent">Tours</span> complète</h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">InvoiceAgent gère les factures fournisseurs et les contrats — les deux besoins essentiels des artisans et PME de Tours et Indre-et-Loire.</p>
        </AnimatedSection>
...
function Pricing() {
  const plans = [
    { name: 'Gratuit', price: '0', description: 'Pour démarrer à Tours', features: ['5 factures fournisseurs/mois', 'Scan smartphone chantier', 'Suivi payé / impayé', 'Tableau de bord simple', 'Export PDF'], cta: 'Commencer gratuitement', popular: false, href: `${BASE_URL}/auth/login` },
    { name: 'Starter', price: '19', description: 'Artisans et PME de Indre-et-Loire', features: ['100 factures / mois', 'TVA 10% et 20% automatique', 'Réconciliation bancaire CSV', 'Alertes factures impayées', 'Export CSV + PDF', 'Tableau de bord complet'], cta: 'Choisir Starter', popular: true, href: `${BASE_URL}/checkout?plan=starter` },
    ...
    { name: 'Business', price: '49', description: 'Multi-chantiers Tours', features: ['Tout Pro inclus', 'Multi-chantiers illimité', 'Analyse contrats illimitée', 'Résumé intelligent', 'Historique RGPD', 'Accompagnement perso'], cta: 'Choisir Business', popular: false, href: `${BASE_URL}/checkout?plan=business` },
  ];
  return (
    ...
    <section id="demo" className="py-24 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Testez le logiciel de facturation pour Tours</h2>
        ...
        <div className="grid grid-cols-3 gap-6 mt-10">
          {[{ value: '7,400', label: 'Artisans en Indre-et-Loire', icon: MapPin }, { value: '< 5s', label: 'Par facture traitée', icon: Zap }, { value: '€0', label: 'Pour commencer', icon: CheckCircle2 }].map((stat) => (
...
function FAQ() {
  const faqs = [
    { q: "Quel logiciel de facturation pour les entreprises à Tours ?", a: "InvoiceAgent est un logiciel de facturation IA pour les artisans, PME et freelances de Tours et Indre-et-Loire. Il automatise l'extraction des factures fournisseurs par OCR, gère la TVA 10% et 20% et génère le FEC conforme DGFiP. Gratuit jusqu'à 5 factures par mois — sans installation." },
    { q: "Comment gérer ses factures fournisseurs à Tours ?", a: "Photographiez vos factures Point P Tours, Brico Dépôt Tours avec votre smartphone depuis le chantier. InvoiceAgent extrait automatiquement le fournisseur, les montants HT/TTC et la TVA en moins de 5 secondes par OCR IA." },
    { q: "InvoiceAgent fonctionne-t-il pour les artisans de Indre-et-Loire ?", a: "Oui. InvoiceAgent est accessible depuis n'importe quel smartphone ou ordinateur, sans installation. Les artisans de Indre-et-Loire peuvent scanner leurs factures depuis le chantier et exporter leur FEC pour leur comptable local à Tours." },
    { q: "Quel expert-comptable à Tours peut importer les exports InvoiceAgent ?", a: "Les exports FEC d'InvoiceAgent sont compatibles avec Sage 100, Cegid Expert et EBP — utilisés par la grande majorité des experts-comptables à Tours et en Centre-Val de Loire. Import direct sans ressaisie." },
    { q: "Puis-je utiliser InvoiceAgent depuis un chantier à Tours ?", a: "Oui. L'interface est optimisée pour smartphone. Photographiez une facture depuis n'importe quel chantier en Indre-et-Loire — l'IA extrait les données en moins de 5 secondes, même en mauvaise lumière." },
  ];
  ...
  return (
    <section className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <AnimatedSection>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">Le logiciel de facturation des artisans et PME de Tours</h2>
          <p className="text-lg text-violet-100 mb-4 max-w-2xl mx-auto">5 factures gratuites — sans carte bancaire, sans installation. Opérationnel depuis Tours en 2 minutes.</p>
...
export default function LogicielFacturationTours() {
  return (
    <>
