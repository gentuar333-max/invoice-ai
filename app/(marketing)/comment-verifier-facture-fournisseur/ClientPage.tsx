...
export default function PageComponent() {
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      <Navigation />
      <Hero title="Comment verifier une facture fournisseur avant paiement" desc="Une facture non verifiee = doublon, frais cache ou TVA perdue. InvoiceAgent controle montants, TVA et mentions en 5 secondes." cta="Verifier ma facture" />
      <Demo title="Verifiez vos factures maintenant" />
      <Pricing />
      ...
      <CTA title="Verifiez chaque facture avant de payer" cta="Verifier ma facture" />
      <SharedFooter />
    </div>
  );
}
