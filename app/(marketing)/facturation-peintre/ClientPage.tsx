...
import { FileText, Zap, Shield, Clock, CheckCircle2, ArrowRight, ChevronDown, Sparkles, Building2, Calculator, FileSearch, Palette, AlertTriangle } from 'lucide-react';
...
const schemaSoftware = { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'InvoiceAgent — Facturation Peintre', applicationCategory: 'BusinessApplication', operatingSystem: 'Web, SaaS', url: PAGE_URL, offers: { '@type': 'AggregateOffer', lowPrice: '0', highPrice: '49', priceCurrency: 'EUR' }, aggregateRating: { '@type': 'AggregateRating', ratingValue: '4.8', reviewCount: '48' } };
const schemaFAQ = {
  '@context': 'https://schema.org', '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: "Quel taux de TVA pour les travaux de peinture ?", acceptedAnswer: { '@type': 'Answer', text: "La peinture en rénovation (logement +2 ans) est taxée à 10% de TVA. En construction neuve : 20%. InvoiceAgent applique automatiquement le bon taux selon le type de chantier." } },
    { '@type': 'Question', name: "Comment gérer les factures peinture et enduits d'un artisan peintre ?", acceptedAnswer: { '@type': 'Answer', text: "InvoiceAgent extrait automatiquement les factures Tollens, Leroy Merlin Pro, Zolpan, Seigneurie depuis le chantier. Chaque facture est traitée en moins de 5 secondes par OCR IA depuis votre smartphone." } },
    { '@type': 'Question', name: "Comment analyser un contrat de chantier peinture ?", acceptedAnswer: { '@type': 'Answer', text: "Uploadez votre devis accepté ou contrat client. L'IA détecte les clauses de responsabilité, les conditions de réception des travaux, les pénalités de retard et les frais cachés — avant de démarrer le chantier." } },
    { '@type': 'Question', name: "Combien de temps gagne-t-on avec InvoiceAgent ?", acceptedAnswer: { '@type': 'Answer', text: "Un artisan peintre qui reçoit 35 factures par mois gagne en moyenne 2 heures par semaine en supprimant la saisie manuelle. Ces 2 heures représentent 2 à 3 chantiers supplémentaires par mois." } },
  ],
};
const schemaBreadcrumb = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Accueil', item: BASE_URL }, { '@type': 'ListItem', position: 2, name: 'Facturation Peintre', item: PAGE_URL }] };
          ...
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="text-center lg:text-left">
            <motion.div variants={fadeInUp}>
              <Badge className="mb-6 px-4 py-2 bg-violet-100 text-violet-700 hover:bg-violet-200 border-0 text-sm font-medium">
                ...
                Pour peintres artisans — factures peinture et contrats de chantier
              </Badge>
            </motion.div>
            <motion.h1 variants={fadeInUp} className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              <span className="bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent">Facturation peintre</span>
              <br />
            ...
            <motion.p variants={fadeInUp} className="text-lg sm:text-xl text-slate-600 mb-6 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Un artisan peintre reçoit en moyenne <strong>35 factures fournisseurs par mois</strong> — peintures, enduits, apprêts, matériel. InvoiceAgent les traite automatiquement par OCR IA depuis votre chantier en moins de 5 secondes.
            </motion.p>
            <motion.div variants={fadeInUp} className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-8 text-left">
              <p className="text-sm font-semibold text-amber-800 mb-1">⚠ Le problème que tout peintre connaît</p>
              <p className="text-sm text-amber-700">Les factures Tollens et Zolpan arrivent chaque semaine avec des dizaines de références. Les saisir manuellement = <strong>2 à 3 heures perdues par semaine</strong>. InvoiceAgent les traite en 5 secondes chacune.</p>
            </motion.div>
            ...
            <div className="bg-white rounded-3xl shadow-2xl shadow-violet-600/20 p-6 border border-slate-100">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-slate-900">Artisan peintre</p>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-4">
                  ...
                  <p className="text-2xl font-bold text-slate-900">€6,840</p>
                  <p className="text-xs text-emerald-600 mt-1">TVA calculée auto</p>
                </div>
              </div>
              <div className="space-y-3">
                {[
                  { client: 'Tollens — Peintures et finitions', amount: '€1,820', status: 'Payée' },
                  { client: 'Zolpan — Enduits et apprêts', amount: '€2,140', status: 'En attente' },
                  { client: 'Seigneurie — Peinture façade', amount: '€980', status: 'Payée' },
                ].map((item, i) => (
            ...
            <motion.div animate={{ y: [0, -10, 0] }} transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }} className="absolute -top-6 -right-6 bg-white rounded-2xl shadow-xl p-4 border border-slate-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-600 font-semibold">Pénalité détectée</p>
                </div>
              </div>
            </motion.div>
...
function Features() {
  const features = [
    { icon: Zap, title: 'OCR factures peinture et enduits', description: "Scannez vos factures Tollens, Zolpan, Seigneurie, Leroy Merlin Pro depuis le chantier. Chaque référence produit, montant HT/TTC et TVA extraits en moins de 5 secondes — même sur tickets froissés.", color: 'from-amber-400 to-orange-500' },
    { icon: Palette, title: 'TVA 10% rénovation et 20% neuf', description: "Peinture en logement +2 ans = TVA 10%. Construction neuve = TVA 20%. InvoiceAgent applique le bon taux automatiquement — zéro erreur sur votre déclaration TVA mensuelle.", color: 'from-violet-400 to-purple-500' },
    { icon: FileText, title: 'Analyse contrats et devis acceptés', description: "Uploadez votre contrat client avant de démarrer. L'IA détecte les clauses de réception manquantes, les pénalités de retard, les exclusions de garantie et les frais cachés.", color: 'from-pink-400 to-rose-500' },
    ...
    { icon: Clock, title: 'Réconciliation bancaire CSV', description: "Importez votre relevé bancaire CSV. L'IA rapproche automatiquement les virements clients avec les chantiers facturés et vos achats fournisseurs peinture.", color: 'from-blue-400 to-indigo-500' },
    { icon: Calculator, title: 'Export FEC conforme DGFiP', description: "Générez votre FEC en un clic. Compatible Sage, EBP, Cegid. Votre comptable gagne du temps — vous économisez sur ses honoraires.", color: 'from-cyan-400 to-blue-500' },
  ];
  return (
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16 lg:mb-20">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 mb-6">
            Factures peinture et contrats <span className="bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-transparent">gérés automatiquement</span>
          </h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">InvoiceAgent gère vos factures fournisseurs peinture et vos contrats clients — les deux outils que chaque artisan peintre utilise chaque semaine.</p>
        </AnimatedSection>
...
function HowItWorks() {
  const steps = [
    { number: '01', title: 'Scannez depuis le chantier', description: "Photographiez vos factures Tollens ou bons de livraison avec votre smartphone. L'analyse démarre automatiquement.", icon: FileText },
    { number: '02', title: "L'IA extrait les données", description: "Fournisseur, SIRET, montants HT/TTC, TVA 10% ou 20% — extrait en moins de 5 secondes. Même sur papier froissé.", icon: Zap },
    { number: '03', title: 'Analysez vos contrats', description: "Uploadez votre contrat client avant signature. L'IA identifie les clauses risquées et pénalités cachées.", icon: FileSearch },
    { number: '04', title: 'Exportez pour votre comptable', description: "FEC conforme DGFiP ou CSV. Votre comptable reçoit un fichier structuré. Vous récupérez 2h par semaine.", icon: Calculator },
  ];
  return (
    <section className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16 lg:mb-20">
          ...
          <p className="text-slate-600 max-w-xl mx-auto">Moins de 5 secondes par facture. Moins de 30 secondes pour analyser un contrat de chantier.</p>
        </AnimatedSection>
...
function Pricing() {
  const plans = [
    ...
    { name: 'Starter', price: '19', description: 'Pour artisans peintres', features: ['100 factures / mois', 'TVA 10% et 20% automatique', 'Réconciliation bancaire CSV', 'Alertes factures impayées', 'Export CSV + PDF', 'Tableau de bord complet'], cta: 'Choisir Starter', popular: true, href: `${BASE_URL}/checkout?plan=starter` },
    { name: 'Pro', price: '29', description: 'Factures + contrats chantier', features: ['Factures illimitées', 'IA correspondances bancaires', 'Export FEC conforme DGFiP', 'Analyse contrats (5/mois)', 'Détection clauses réception', 'Pénalités de retard identifiées'], cta: 'Choisir Pro', popular: false, href: `${BASE_URL}/checkout?plan=pro` },
    { name: 'Business', price: '49', description: 'Entreprises peinture multi-chantiers', features: ['Tout Pro inclus', 'Multi-chantiers illimité', 'Analyse contrats illimitée', 'Résumé intelligent', 'Historique sécurisé RGPD', 'Accompagnement personnalisé'], cta: 'Choisir Business', popular: false, href: `${BASE_URL}/checkout?plan=business` },
  ];
  return (
    ...
    <section id="demo" className="py-24 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Testez avec une vraie facture Tollens ou un contrat de chantier</h2>
          <p className="text-lg text-violet-200 max-w-2xl mx-auto">Importez une facture fournisseur peinture ou un contrat client — l'IA extrait et analyse tout en quelques secondes.</p>
        </AnimatedSection>
        ...
        <div className="grid grid-cols-3 gap-6 mt-10">
          {[{ value: '35', label: 'Factures/mois en moyenne', icon: FileText }, { value: '2h', label: 'Gagnées par semaine', icon: Clock }, { value: '€0', label: 'Pour commencer', icon: CheckCircle2 }].map((stat) => (
...
function FAQ() {
  const faqs = [
    { q: "Quel taux de TVA pour les travaux de peinture ?", a: "La peinture en rénovation (logement de plus de 2 ans) est taxée à 10% de TVA. En construction neuve ou locaux professionnels, le taux est de 20%. InvoiceAgent applique automatiquement le bon taux selon le chantier — sans erreur possible sur votre déclaration TVA." },
    { q: "Comment gérer les factures peinture et enduits d'un artisan peintre ?", a: "InvoiceAgent extrait automatiquement les factures Tollens, Zolpan, Seigneurie, Leroy Merlin Pro depuis le chantier. Chaque référence produit, montant HT/TTC et TVA sont extraits en moins de 5 secondes par OCR IA — même sur tickets froissés ou bons de livraison." },
    { q: "Comment analyser un contrat de chantier peinture ?", a: "Uploadez votre devis accepté ou contrat client dans InvoiceAgent. L'IA détecte les clauses de réception des travaux manquantes, les pénalités de retard de paiement, les exclusions de garantie et les frais cachés — avant de démarrer le chantier." },
    { q: "Combien de temps gagne-t-on avec InvoiceAgent ?", a: "Un artisan peintre qui reçoit 35 factures par mois gagne en moyenne 2 heures par semaine en supprimant la saisie manuelle. Ces 2 heures représentent 2 à 3 chantiers supplémentaires par mois selon votre tarif horaire." },
    { q: "Puis-je exporter vers mon expert-comptable ?", a: "Oui. Export FEC natif compatible Sage, EBP et Cegid. Export CSV et PDF disponibles. Votre comptable spécialisé artisans reçoit un fichier propre — sans ressaisie manuelle." },
  ];
  ...
  return (
    <section className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <AnimatedSection>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">Récupérez 2 heures par semaine sur vos factures peinture</h2>
          <p className="text-lg sm:text-xl text-violet-100 mb-4 max-w-2xl mx-auto">5 factures gratuites — sans carte bancaire, sans installation. Opérationnel depuis votre chantier en 2 minutes.</p>
...
function InternalLinks() {
  const links = [
    ...
    { label: 'Facturation Menuisier', href: `${BASE_URL}/facturation-menuisier` },
...
export default function FacturationPeintre() {
  return (
    <>
