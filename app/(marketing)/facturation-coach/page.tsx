...
import { FileText, Zap, Shield, Clock, CheckCircle2, ArrowRight, ChevronDown, Sparkles, Building2, Calculator, FileSearch, Users, Target, TrendingUp } from 'lucide-react';
...
const schemaSoftware = { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'InvoiceAgent — Facturation Coach', applicationCategory: 'BusinessApplication', operatingSystem: 'Web, SaaS', url: PAGE_URL, offers: { '@type': 'AggregateOffer', lowPrice: '0', highPrice: '49', priceCurrency: 'EUR' }, aggregateRating: { '@type': 'AggregateRating', ratingValue: '4.9', reviewCount: '38' } };
const schemaFAQ = {
  '@context': 'https://schema.org', '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: "Les coachs sont-ils soumis à la TVA ?", acceptedAnswer: { '@type': 'Answer', text: "Les coachs professionnels sont soumis à la TVA au taux de 20% sur leurs honoraires. Certaines formations certifiées Qualiopi peuvent être exonérées. InvoiceAgent gère automatiquement ces distinctions." } },
    { '@type': 'Question', name: "Comment gérer la facturation de séances de coaching ?", acceptedAnswer: { '@type': 'Answer', text: "InvoiceAgent extrait et classe automatiquement les factures fournisseurs de votre activité de coaching. Les honoraires de sous-traitance, locations de salles et outils sont traités en moins de 5 secondes par OCR IA." } },
    { '@type': 'Question', name: "InvoiceAgent fonctionne-t-il pour les coachs en micro-entreprise ?", acceptedAnswer: { '@type': 'Answer', text: "Oui. Le plan Gratuit couvre 5 factures par mois, idéal pour démarrer. Le plan Starter à 19€/mois couvre 100 factures et inclut la réconciliation bancaire CSV." } },
...
const schemaBreadcrumb = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Accueil', item: BASE_URL }, { '@type': 'ListItem', position: 2, name: 'Facturation Coach', item: PAGE_URL }] };
          ...
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="text-center lg:text-left">
            <motion.div variants={fadeInUp}>
              <Badge className="mb-6 px-4 py-2 bg-violet-100 text-violet-700 hover:bg-violet-200 border-0 text-sm font-medium">
                ...
                Solution comptable pour coachs et formateurs
              </Badge>
            </motion.div>
            <motion.h1 variants={fadeInUp} className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              <span className="bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent">Facturation coach</span>
              <br />
            ...
            <motion.p variants={fadeInUp} className="text-lg sm:text-xl text-slate-600 mb-8 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Gérez vos factures fournisseurs, honoraires de sous-traitance et notes de frais automatiquement. InvoiceAgent extrait les données par OCR IA — TVA 20% gérée automatiquement, export FEC conforme DGFiP.
            </motion.p>
            ...
            <div className="bg-white rounded-3xl shadow-2xl shadow-violet-600/20 p-6 border border-slate-100">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-slate-900">Coach indépendant</p>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="bg-gradient-to-br from-violet-50 to-indigo-50 rounded-2xl p-4">
                  ...
                  <p className="text-2xl font-bold text-slate-900">€12,800</p>
                ...
                <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-4">
                  <p className="text-sm text-slate-500 mb-1">Factures traitées</p>
              ...
              <div className="space-y-3">
                {[
                  { client: 'Location salle — Espace Bien-être', amount: '€320', status: 'Payée' },
                  { client: 'Sous-traitance — Coach associé', amount: '€1,200', status: 'En attente' },
                  { client: 'Abonnement outils coaching', amount: '€89', status: 'Payée' },
                ].map((item, i) => (
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-12">
          ...
          <p className="text-lg text-violet-200 max-w-2xl mx-auto">
            Importez une facture fournisseur ou un contrat — l'IA extrait toutes les données comptables en quelques secondes. Gratuit, sans inscription requise.
          </p>
        </AnimatedSection>
        <motion.div
        ...
        <div className="grid grid-cols-3 gap-6 mt-10">
          {[
            ...
            { value: '98%', label: 'Précision OCR IA', icon: Target },
...
function Features() {
  const features = [
    { icon: Zap, title: 'OCR factures fournisseurs', description: "Importez vos factures de locations de salles, sous-traitants et abonnements d'outils. L'IA extrait fournisseur, SIRET, montants et TVA en moins de 5 secondes.", color: 'from-amber-400 to-orange-500' },
    { icon: TrendingUp, title: 'Gestion TVA coaching', description: "TVA 20% sur les honoraires de coaching, exonération possible pour les formations certifiées Qualiopi — InvoiceAgent gère automatiquement ces distinctions.", color: 'from-violet-400 to-purple-500' },
    { icon: Shield, title: 'Conformité RGPD', description: "InvoiceAgent traite uniquement les données comptables. Aucune donnée confidentielle de vos clients coachés n'est collectée. Hébergement Frankfurt (UE).", color: 'from-emerald-400 to-teal-500' },
    { icon: Clock, title: 'Réconciliation bancaire CSV', description: "Importez votre relevé bancaire CSV. L'IA rapproche automatiquement les virements de vos clients avec les honoraires facturés.", color: 'from-blue-400 to-indigo-500' },
    { icon: Users, title: 'Suivi sous-traitants', description: "Gérez les factures de vos coachs associés et sous-traitants. Chaque prestaire est reconnu par son SIRET et suivi automatiquement.", color: 'from-pink-400 to-rose-500' },
    { icon: Calculator, title: 'Export FEC conforme DGFiP', description: "Générez votre FEC en un clic. Compatible Sage, EBP, Cegid et les logiciels utilisés par les experts-comptables en professions libérales.", color: 'from-cyan-400 to-blue-500' },
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16 lg:mb-20">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 mb-6">
            Conçu pour les
            <span className="bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-transparent"> coachs indépendants</span>
          </h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Une suite d'outils adaptée aux spécificités comptables des coachs et formateurs français.
          </p>
        </AnimatedSection>
...
function HowItWorks() {
  const steps = [
    { number: '01', title: 'Importez vos factures', description: "Glissez vos factures fournisseurs PDF ou photographiez-les. L'analyse démarre automatiquement.", icon: FileText },
    { number: '02', title: "L'IA extrait les données", description: "Fournisseur, SIRET, montants HT/TTC, TVA extraits en moins de 5 secondes.", icon: Zap },
    { number: '03', title: 'Vérifiez et validez', description: "Contrôlez les données extraites et enregistrez en un clic. Doublons détectés automatiquement.", icon: CheckCircle2 },
    { number: '04', title: 'Exportez pour votre comptable', description: "Générez votre FEC conforme DGFiP ou exportez en CSV.", icon: Calculator },
  ];
...
function Pricing() {
  const plans = [
    ...
    { name: 'Starter', price: '19', description: 'Pour coachs indépendants', features: ['100 factures / mois', 'Calcul TVA automatique', 'Réconciliation bancaire CSV', 'Alertes factures impayées', 'Export CSV + PDF', 'Tableau de bord complet'], cta: 'Choisir Starter', popular: true, href: `${BASE_URL}/checkout?plan=starter` },
    { name: 'Pro', price: '29', description: 'Automatisation avancée', features: ['Factures illimitées', 'IA correspondances bancaires', 'Export FEC conforme DGFiP', 'Analyse contrats (5/mois)', 'Détection clauses à risque', 'Frais cachés identifiés'], cta: 'Choisir Pro', popular: false, href: `${BASE_URL}/checkout?plan=pro` },
    { name: 'Business', price: '49', description: 'Cabinets de coaching', features: ['Tout Pro inclus', 'Multi-coachs simplifié', 'Analyse contrats illimitée', 'Résumé intelligent', 'Historique sécurisé RGPD', 'Accompagnement personnalisé'], cta: 'Choisir Business', popular: false, href: `${BASE_URL}/checkout?plan=business` },
  ];
...
function FAQ() {
  const faqs = [
    { q: "Les coachs sont-ils soumis à la TVA ?", a: "Les coachs professionnels sont soumis à la TVA au taux normal de 20% sur leurs honoraires de coaching individuel et collectif. Certaines formations certifiées Qualiopi peuvent être totalement exonérées de TVA. Si vous êtes en franchise de base TVA (chiffre d'affaires inférieur à 37 500€), vous ne collectez pas de TVA. InvoiceAgent gère automatiquement toutes ces situations." },
    { q: "Comment gérer les factures de location de salle et sous-traitance ?", a: "InvoiceAgent extrait automatiquement les factures de vos fournisseurs — locations de salles, honoraires de coachs associés sous-traités, abonnements d'outils (Zoom, plateformes LMS, outils de coaching). Chaque prestataire est reconnu par son SIRET et ses factures sont classées automatiquement." },
    { q: "InvoiceAgent fonctionne-t-il pour les coachs en micro-entreprise ?", a: "Oui. Le plan Gratuit couvre 5 factures fournisseurs par mois, idéal pour démarrer. Le plan Starter à 19€/mois couvre 100 factures et inclut la réconciliation bancaire CSV — adapté aux coachs en pleine croissance." },
    { q: "Comment exporter les données pour mon expert-comptable ?", a: "Export FEC natif compatible Sage, EBP et Cegid. Export CSV et PDF également disponibles. Votre expert-comptable peut importer directement sans ressaisie manuelle." },
    { q: "InvoiceAgent peut-il analyser mes contrats avec mes clients ?", a: "Oui, dès le plan Pro à 29€/mois. Uploadez votre contrat de coaching ou convention de formation. L'IA identifie les clauses de responsabilité, les conditions d'annulation et les frais cachés éventuels." },
  ];
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <AnimatedSection>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">
            Automatisez la comptabilité de votre activité de coaching
          </h2>
...
export default function FacturationCoach() {
  return (
    <>
