...
const PAGE_URL = `${BASE_URL}/logiciel-facturation-grenoble`;
...
const schemaSoftware = { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'InvoiceAgent — Logiciel Facturation Grenoble', applicationCategory: 'BusinessApplication', operatingSystem: 'Web, SaaS', url: PAGE_URL, offers: { '@type': 'AggregateOffer', lowPrice: '0', highPrice: '49', priceCurrency: 'EUR' }, aggregateRating: { '@type': 'AggregateRating', ratingValue: '4.8', reviewCount: '29' } };
const schemaFAQ = {
  '@context': 'https://schema.org', '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: "Quel logiciel de facturation pour les entreprises à Grenoble ?", acceptedAnswer: { '@type': 'Answer', text: "InvoiceAgent est un logiciel de facturation IA pour les artisans, PME et freelances de Grenoble et de l'Isère. Il automatise l'extraction des factures par OCR, gère la TVA et génère le FEC conforme DGFiP. Gratuit jusqu'à 5 factures par mois." } },
    { '@type': 'Question', name: "Comment gérer ses factures fournisseurs à Grenoble ?", acceptedAnswer: { '@type': 'Answer', text: "Photographiez vos factures Point P Grenoble et Socoda avec votre smartphone. InvoiceAgent extrait fournisseur, montants HT/TTC et TVA en moins de 5 secondes par OCR IA." } },
    { '@type': 'Question', name: "InvoiceAgent fonctionne-t-il pour les artisans de l'Isère ?", acceptedAnswer: { '@type': 'Answer', text: "Oui. InvoiceAgent est utilisé par des artisans et PME partout en France dont Grenoble et l'Isère. Accessible depuis smartphone ou ordinateur, sans installation." } },
  ],
};
const schemaBreadcrumb = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Accueil', item: BASE_URL }, { '@type': 'ListItem', position: 2, name: 'Logiciel Facturation Grenoble', item: PAGE_URL }] };
const schemaLocal = { '@context': 'https://schema.org', '@type': 'LocalBusiness', name: 'InvoiceAgent — Grenoble', url: PAGE_URL, description: 'Logiciel de facturation IA pour artisans et PME à Grenoble', areaServed: { '@type': 'City', name: 'Grenoble' } };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="flex items-center gap-3">
            <Button variant="ghost" className="hidden sm:flex text-slate-600 hover:text-violet-600" asChild><a href={`${BASE_URL}/auth/login`}>Connexion</a></Button>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="text-center lg:text-left">
            <motion.div variants={fadeInUp}>
              <Badge className="mb-6 px-4 py-2 bg-violet-100 text-violet-700 border-0 text-sm font-medium">
                <MapPin className="w-4 h-4 mr-2" />Logiciel de facturation pour artisans et PME à Grenoble
              </Badge>
            </motion.div>
            <motion.h1 variants={fadeInUp} className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              ...
              <span className="bg-gradient-to-r from-violet-600 via-indigo-600 to-violet-600 bg-clip-text text-transparent">Grenoble</span><br />
            ...
            <motion.p variants={fadeInUp} className="text-lg sm:text-xl text-slate-600 mb-6 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Plus de <strong>9,800 artisans et 7,200 PME</strong> en Isère gèrent des dizaines de factures fournisseurs chaque mois. InvoiceAgent les traite automatiquement par OCR IA — depuis n'importe quel chantier ou bureau à Grenoble.
            </motion.p>
            <motion.div variants={fadeInUp} className="grid grid-cols-3 gap-3 mb-8">
              {[{ value: '9,800', label: 'Artisans', sub: "en Isère" }, { value: '< 5s', label: 'Par facture', sub: 'OCR IA auto' }, { value: '€0', label: 'Pour démarrer', sub: '5 factures/mois' }].map((stat) => (
            ...
            <motion.div variants={fadeInUp} className="bg-indigo-50 border border-indigo-100 rounded-xl p-4 mb-6 text-left">
              <p className="text-sm text-indigo-700 leading-relaxed"><span className="font-semibold">📍 Grenoble :</span> Capitale des Alpes, Grenoble concentre un tissu dense d'artisans BTP spécialisés en rénovation thermique et travaux en altitude. Le marché immobilier dynamique de l'Isère génère une activité soutenue pour les entreprises locales.</p>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="flex flex-wrap items-center justify-center lg:justify-start gap-6 text-sm text-slate-500">
              {["Gratuit jusqu'à 5 factures/mois", "Point P Grenoble reconnu auto", "Contrats analysés par IA"].map((item) => (
          ...
          <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 1, delay: 0.3 }} className="relative">
            <div className="bg-white rounded-3xl shadow-2xl shadow-violet-600/20 p-6 border border-slate-100">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div><p className="font-semibold text-slate-900">Artisan — Grenoble</p><p className="text-sm text-slate-500">Isère</p></div>
                </div>
              ...
              <div className="space-y-3">
                {[{ client: 'Point P Grenoble — Matériaux', amount: '€3,840', status: 'Payée' }, { client: 'Socoda Isère — Outillage', amount: '€1,280', status: 'En attente' }, { client: 'Fournisseur local — Béton', amount: '€2,120', status: 'Payée' }].map((item, i) => (
            ...
            <motion.div animate={{ y: [0, 10, 0] }} transition={{ duration: 4, repeat: Infinity, ease: 'easeInOut', delay: 0.5 }} className="absolute -bottom-4 -left-4 bg-white rounded-2xl shadow-xl p-4 border border-slate-100">
              <div className="flex items-center gap-2"><MapPin className="w-5 h-5 text-violet-500" /><span className="text-sm font-medium text-slate-900">Grenoble</span><span className="text-xs text-slate-500">38000</span></div>
            </motion.div>
          </motion.div>
        </div>
      </motion.div>
...
function Features() {
  const features = [
    { icon: Zap, title: 'OCR factures fournisseurs — Grenoble', description: "Scannez vos factures Point P Grenoble et Socoda depuis le chantier. Fournisseur, montants HT/TTC, TVA extraits en moins de 5 secondes par OCR IA.", color: 'from-amber-400 to-orange-500' },
    { icon: FileText, title: 'TVA 10% et 20% automatique', description: "Rénovation en logement +2 ans = TVA 10%. Construction neuve = TVA 20%. InvoiceAgent applique automatiquement le bon taux selon le chantier.", color: 'from-violet-400 to-purple-500' },
    { icon: FileSearch, title: 'Analyse contrats de chantier', description: "Uploadez vos contrats clients avant de démarrer. L'IA détecte les clauses de garantie manquantes, pénalités de retard et frais cachés.", color: 'from-pink-400 to-rose-500' },
    { icon: Shield, title: 'RGPD — données en Europe', description: "Vos données hébergées sur serveurs certifiés RGPD en Europe (Frankfurt). Chiffrement AES-256.", color: 'from-emerald-400 to-teal-500' },
    ...
    { icon: Calculator, title: 'Export FEC conforme DGFiP', description: "Générez votre FEC en un clic. Compatible Sage, EBP, Cegid. Votre expert-comptable de Grenoble reçoit un fichier structuré.", color: 'from-cyan-400 to-blue-500' },
  ];
  return (
    <section id="features" className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 mb-6">Application facturation <span className="bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-transparent">Grenoble</span> complète</h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">InvoiceAgent gère les factures fournisseurs et les contrats — les deux besoins essentiels des artisans et PME de Grenoble et de l'Isère.</p>
        </AnimatedSection>
...
function Pricing() {
  const plans = [
    { name: 'Gratuit', price: '0', description: 'Pour démarrer à Grenoble', features: ['5 factures fournisseurs/mois', 'Scan smartphone chantier', 'Suivi payé / impayé', 'Tableau de bord simple', 'Export PDF'], cta: 'Commencer gratuitement', popular: false, href: `${BASE_URL}/auth/login` },
    { name: 'Starter', price: '19', description: 'Artisans et PME de l\'Isère', features: ['100 factures / mois', 'TVA 10% et 20% automatique', 'Réconciliation bancaire CSV', 'Alertes factures impayées', 'Export CSV + PDF', 'Tableau de bord complet'], cta: 'Choisir Starter', popular: true, href: `${BASE_URL}/checkout?plan=starter` },
    { name: 'Pro', price: '29', description: 'Factures + contrats chantier', features: ['Factures illimitées', 'IA correspondances bancaires', 'Export FEC conforme DGFiP', 'Analyse contrats (5/mois)', 'Détection clauses risque', 'Pénalités identifiées'], cta: 'Choisir Pro', popular: false, href: `${BASE_URL}/checkout?plan=pro` },
    { name: 'Business', price: '49', description: 'Multi-chantiers Grenoble', features: ['Tout Pro inclus', 'Multi-chantiers illimité', 'Analyse contrats illimitée', 'Résumé intelligent', 'Historique RGPD', 'Accompagnement perso'], cta: 'Choisir Business', popular: false, href: `${BASE_URL}/checkout?plan=business` },
  ];
  return (
    ...
    <section id="demo" className="py-24 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Testez le logiciel de facturation pour Grenoble</h2>
        ...
        <div className="grid grid-cols-3 gap-6 mt-10">
          {[{ value: '9,800', label: 'Artisans en Isère', icon: MapPin }, { value: '< 5s', label: 'Par facture traitée', icon: Zap }, { value: '€0', label: 'Pour commencer', icon: CheckCircle2 }].map((stat) => (
...
function FAQ() {
  const faqs = [
    { q: "Quel logiciel de facturation pour les entreprises à Grenoble ?", a: "InvoiceAgent est un logiciel de facturation IA pour les artisans, PME et freelances de Grenoble et de l'Isère. Il automatise l'extraction des factures fournisseurs par OCR, gère la TVA 10% et 20% et génère le FEC conforme DGFiP. Gratuit jusqu'à 5 factures par mois — sans installation." },
    { q: "Comment gérer ses factures fournisseurs à Grenoble ?", a: "Photographiez vos factures Point P Grenoble et Socoda avec votre smartphone depuis le chantier. InvoiceAgent extrait automatiquement le fournisseur, les montants HT/TTC et la TVA en moins de 5 secondes par OCR IA." },
    { q: "InvoiceAgent fonctionne-t-il pour les artisans de l'Isère ?", a: "Oui. InvoiceAgent est accessible depuis n'importe quel smartphone ou ordinateur, sans installation. Les artisans de l'Isère peuvent scanner leurs factures depuis le chantier et exporter leur FEC pour leur comptable local à Grenoble." },
    { q: "Quel expert-comptable à Grenoble peut importer les exports InvoiceAgent ?", a: "Les exports FEC d'InvoiceAgent sont compatibles avec Sage 100, Cegid Expert et EBP — utilisés par la grande majorité des experts-comptables à Grenoble et en Isère. Import direct sans ressaisie." },
    { q: "Puis-je utiliser InvoiceAgent depuis un chantier à Grenoble ?", a: "Oui. L'interface est optimisée pour smartphone. Photographiez une facture depuis n'importe quel chantier en Isère — l'IA extrait les données en moins de 5 secondes, même en mauvaise lumière." },
  ];
  ...
  return (
    <section className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <AnimatedSection>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">Le logiciel de facturation des artisans et PME de Grenoble</h2>
          <p className="text-lg text-violet-100 mb-4 max-w-2xl mx-auto">5 factures gratuites — sans carte bancaire, sans installation. Opérationnel depuis Grenoble en 2 minutes.</p>
...
function InternalLinks() {
  const links = [
    ...
    { label: 'Logiciel facturation Lyon', href: `${BASE_URL}/logiciel-facturation-lyon` },
  ];
  return (
    <section className="py-12 bg-slate-50 border-t border-slate-200">
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {links.map((link) => (
            <a key={link.label} href={link.href} className="bg-white border border-slate-200 rounded-lg px-4 py-2 text-sm text-violet-700 font-medium hover:border-violet-300 transition-all">{link.label}</a>
          ))}
        </div>
      </div>
    </section>
...
export default function LogicielFacturationGrenoble() {
  return (
    <>
