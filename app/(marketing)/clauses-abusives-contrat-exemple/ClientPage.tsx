...
export default function PageComponent() {
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      <Navigation />
      <Hero title="Clauses abusives contrat fournisseur : exemples et detection" desc="Non-concurrence excessive, cession totale de droits, penalites disproportionnees — InvoiceAgent detecte les clauses abusives en 30 secondes." cta="Analyser mon contrat" />
      <Demo title="Analysez votre contrat maintenant" />
      <Pricing />
      ...
      <CTA title="Detectez les clauses abusives avant de signer" cta="Analyser mon contrat" />
      <SharedFooter />
    </div>
  );
}
