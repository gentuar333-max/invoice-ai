...
export default function PageComponent() {
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      <Navigation />
      <Hero title="Controle facture automatique : stoppez les pertes avant paiement" desc="Chaque facture non controlee est une perte potentielle. InvoiceAgent verifie doublons, TVA et frais caches en 5 secondes par facture." cta="Controler mes factures" />
      <Demo title="Controlez vos factures maintenant" />
      <Pricing />
      ...
      <CTA title="Stoppez les pertes avant paiement" cta="Controler mes factures" />
      <SharedFooter />
    </div>
  );
}
