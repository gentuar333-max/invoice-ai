...
import { FileText, Zap, Shield, Clock, CheckCircle2, ArrowRight, ChevronDown, Sparkles, Building2, Calculator, FileSearch, Grid3X3, AlertTriangle } from 'lucide-react';
...
const schemaSoftware = { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'InvoiceAgent — Facturation Carreleur', applicationCategory: 'BusinessApplication', operatingSystem: 'Web, SaaS', url: PAGE_URL, offers: { '@type': 'AggregateOffer', lowPrice: '0', highPrice: '49', priceCurrency: 'EUR' }, aggregateRating: { '@type': 'AggregateRating', ratingValue: '4.8', reviewCount: '41' } };
const schemaFAQ = {
  '@context': 'https://schema.org', '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: "Quel taux de TVA pour les travaux de carrelage ?", acceptedAnswer: { '@type': 'Answer', text: "Le carrelage en rénovation (logement +2 ans) est taxé à 10% de TVA. En construction neuve : 20%. InvoiceAgent applique automatiquement le bon taux selon le type de chantier." } },
    { '@type': 'Question', name: "Comment gérer les factures carrelage et matériaux d'un carreleur ?", acceptedAnswer: { '@type': 'Answer', text: "InvoiceAgent extrait automatiquement les factures Point P, Leroy Merlin Pro, Cedeo, Saint-Gobain depuis le chantier. Chaque référence carrelage, colle, joint — extrait en moins de 5 secondes par OCR IA." } },
    { '@type': 'Question', name: "Pourquoi analyser ses contrats de pose carrelage ?", acceptedAnswer: { '@type': 'Answer', text: "Un contrat de carrelage sans clause de réception ou de tolerance sur les défauts peut exposer le carreleur à des reprises coûteuses. InvoiceAgent détecte ces clauses manquantes et les pénalités cachées avant signature." } },
    { '@type': 'Question', name: "InvoiceAgent fonctionne-t-il depuis le chantier ?", acceptedAnswer: { '@type': 'Answer', text: "Oui. Photographiez vos factures carrelage depuis n'importe quel chantier avec votre smartphone. L'IA extrait toutes les données en moins de 5 secondes." } },
  ],
};
const schemaBreadcrumb = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Accueil', item: BASE_URL }, { '@type': 'ListItem', position: 2, name: 'Facturation Carreleur', item: PAGE_URL }] };
          ...
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="text-center lg:text-left">
            <motion.div variants={fadeInUp}>
              <Badge className="mb-6 px-4 py-2 bg-violet-100 text-violet-700 hover:bg-violet-200 border-0 text-sm font-medium">
                ...
                Pour carreleurs — factures carrelage et contrats de pose
              </Badge>
            </motion.div>
            <motion.h1 variants={fadeInUp} className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              <span className="bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent">Facturation carreleur</span>
              <br />
            ...
            <motion.p variants={fadeInUp} className="text-lg sm:text-xl text-slate-600 mb-6 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Un carreleur indépendant reçoit en moyenne <strong>45 factures fournisseurs par mois</strong> — pllaka, colle, joints, outillage. InvoiceAgent les traite automatiquement par OCR IA depuis votre chantier en moins de 5 secondes.
            </motion.p>
            <motion.div variants={fadeInUp} className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-8 text-left">
              <p className="text-sm font-semibold text-amber-800 mb-1">⚠ Le risque méconnu du carreleur</p>
              <p className="text-sm text-amber-700">Les factures Point P et Cedeo incluent souvent des <strong>frais de port et de coupe</strong> non détaillés. Sans contrôle, ces frais s'accumulent. InvoiceAgent détecte chaque ligne et les anomalies sur vos factures fournisseurs.</p>
            </motion.div>
            ...
            <div className="bg-white rounded-3xl shadow-2xl shadow-violet-600/20 p-6 border border-slate-100">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-slate-900">Carreleur indépendant</p>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-4">
                  ...
                  <p className="text-2xl font-bold text-slate-900">€18,340</p>
                  <p className="text-xs text-emerald-600 mt-1">TVA calculée auto</p>
                </div>
              </div>
              <div className="space-y-3">
                {[
                  { client: 'Point P — Carrelage et faïence', amount: '€5,240', status: 'Payée' },
                  { client: 'Cedeo — Colle et joints', amount: '€1,890', status: 'En attente' },
                  { client: 'Saint-Gobain — Isolation sols', amount: '€3,120', status: 'Payée' },
                ].map((item, i) => (
            ...
            <motion.div animate={{ y: [0, -10, 0] }} transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }} className="absolute -top-6 -right-6 bg-white rounded-2xl shadow-xl p-4 border border-slate-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-600 font-semibold">Clause risque</p>
                </div>
              </div>
            </motion.div>
...
function Features() {
  const features = [
    { icon: Zap, title: 'OCR factures carrelage et matériaux', description: "Scannez vos factures Point P, Cedeo, Leroy Merlin Pro, Saint-Gobain depuis le chantier. Chaque référence carrelage, colle, joint et frais de port extrait en moins de 5 secondes.", color: 'from-amber-400 to-orange-500' },
    { icon: Grid3X3, title: 'TVA 10% rénovation et 20% neuf', description: "Carrelage en logement +2 ans = TVA 10%. Construction neuve = TVA 20%. InvoiceAgent applique le bon taux automatiquement selon le chantier — aucune erreur sur votre déclaration.", color: 'from-violet-400 to-purple-500' },
    { icon: FileText, title: 'Analyse contrats de pose', description: "Uploadez votre devis accepté avant de démarrer. L'IA détecte les clauses de tolérance sur défauts, les conditions de réception, les pénalités de retard et les frais de reprise cachés.", color: 'from-pink-400 to-rose-500' },
    ...
    { icon: Clock, title: 'Réconciliation bancaire CSV', description: "Importez votre relevé bancaire CSV. L'IA rapproche automatiquement les virements clients avec les chantiers facturés et vos achats fournisseurs carrelage.", color: 'from-blue-400 to-indigo-500' },
    { icon: Calculator, title: 'Export FEC conforme DGFiP', description: "Générez votre FEC en un clic. Compatible Sage, EBP, Cegid. En cas de contrôle fiscal, votre dossier est complet. Votre comptable gagne du temps.", color: 'from-cyan-400 to-blue-500' },
  ];
  return (
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16 lg:mb-20">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 mb-6">
            Factures carrelage et contrats <span className="bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-transparent">gérés automatiquement</span>
          </h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">InvoiceAgent gère vos factures fournisseurs carrelage et vos contrats clients — les deux outils essentiels pour un carreleur indépendant.</p>
        </AnimatedSection>
...
function HowItWorks() {
  const steps = [
    { number: '01', title: 'Scannez depuis le chantier', description: "Photographiez vos factures Point P ou bons de livraison avec votre smartphone. L'analyse démarre automatiquement.", icon: FileText },
    { number: '02', title: "L'IA extrait les données", description: "Fournisseur, SIRET, références carrelage, montants HT/TTC, TVA — extrait en moins de 5 secondes.", icon: Zap },
    { number: '03', title: 'Analysez vos contrats', description: "Uploadez votre contrat client. L'IA détecte les clauses de tolérance manquantes et les pénalités cachées.", icon: FileSearch },
    { number: '04', title: 'Exportez pour votre comptable', description: "FEC conforme DGFiP ou CSV. Votre comptable reçoit un fichier structuré — sans ressaisie.", icon: Calculator },
  ];
  return (
    <section className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16 lg:mb-20">
          ...
          <p className="text-slate-600 max-w-xl mx-auto">Moins de 5 secondes par facture. Moins de 30 secondes pour analyser un contrat de pose.</p>
        </AnimatedSection>
...
function Pricing() {
  const plans = [
    ...
    { name: 'Starter', price: '19', description: 'Pour carreleurs indépendants', features: ['100 factures / mois', 'TVA 10% et 20% automatique', 'Réconciliation bancaire CSV', 'Alertes factures impayées', 'Export CSV + PDF', 'Tableau de bord complet'], cta: 'Choisir Starter', popular: true, href: `${BASE_URL}/checkout?plan=starter` },
    { name: 'Pro', price: '29', description: 'Factures + contrats pose', features: ['Factures illimitées', 'IA correspondances bancaires', 'Export FEC conforme DGFiP', 'Analyse contrats (5/mois)', 'Détection clauses tolérance', 'Pénalités de retard identifiées'], cta: 'Choisir Pro', popular: false, href: `${BASE_URL}/checkout?plan=pro` },
    { name: 'Business', price: '49', description: 'Entreprises carrelage multi-chantiers', features: ['Tout Pro inclus', 'Multi-chantiers illimité', 'Analyse contrats illimitée', 'Résumé intelligent', 'Historique sécurisé RGPD', 'Accompagnement personnalisé'], cta: 'Choisir Business', popular: false, href: `${BASE_URL}/checkout?plan=business` },
  ];
  return (
    ...
    <section id="demo" className="py-24 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Testez avec une vraie facture Point P ou un contrat de pose</h2>
          <p className="text-lg text-violet-200 max-w-2xl mx-auto">Importez une facture fournisseur carrelage ou un contrat client — l'IA extrait et analyse tout en quelques secondes.</p>
        </AnimatedSection>
        ...
        <div className="grid grid-cols-3 gap-6 mt-10">
          {[{ value: '45', label: 'Factures/mois en moyenne', icon: FileText }, { value: '< 5s', label: 'Par facture traitée', icon: Zap }, { value: '€0', label: 'Pour commencer', icon: CheckCircle2 }].map((stat) => (
...
function FAQ() {
  const faqs = [
    { q: "Quel taux de TVA pour les travaux de carrelage ?", a: "Le carrelage en rénovation (logement de plus de 2 ans) est taxé à 10% de TVA. En construction neuve ou locaux professionnels, le taux est de 20%. InvoiceAgent applique automatiquement le bon taux selon le type de chantier — sans erreur sur votre déclaration TVA." },
    { q: "Comment gérer les factures carrelage et matériaux d'un carreleur ?", a: "InvoiceAgent extrait automatiquement les factures Point P, Cedeo, Leroy Merlin Pro, Saint-Gobain depuis le chantier. Chaque référence carrelage, colle, joint et frais de port est extrait en moins de 5 secondes par OCR IA — même sur bons de livraison froissés." },
    { q: "Pourquoi analyser ses contrats de pose carrelage ?", a: "Un contrat de carrelage sans clause de tolérance sur les défauts ou sans conditions de réception claires peut exposer le carreleur à des reprises coûteuses à sa charge. InvoiceAgent détecte ces clauses manquantes, les pénalités de retard et les frais cachés avant que vous signiez." },
    { q: "InvoiceAgent fonctionne-t-il depuis le chantier ?", a: "Oui. Photographiez vos factures carrelage depuis n'importe quel chantier avec votre smartphone. L'IA extrait toutes les données en moins de 5 secondes — même en mauvaise lumière ou si la facture est partiellement illisible." },
  ...
  return (
    <section className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <AnimatedSection>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">Gérez vos factures carrelage depuis n'importe quel chantier</h2>
...
function InternalLinks() {
  const links = [
    ...
    { label: 'Facturation Peintre', href: `${BASE_URL}/facturation-peintre` },
...
export default function FacturationCarreleur() {
  return (
    <>
