...
import { FileText, Zap, Shield, Clock, CheckCircle2, ArrowRight, ChevronDown, Sparkles, Building2, Calculator, FileSearch, HardHat, AlertTriangle, Layers } from 'lucide-react';
...
const schemaSoftware = { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'InvoiceAgent — Facturation Maçon', applicationCategory: 'BusinessApplication', operatingSystem: 'Web, SaaS', url: PAGE_URL, offers: { '@type': 'AggregateOffer', lowPrice: '0', highPrice: '49', priceCurrency: 'EUR' }, aggregateRating: { '@type': 'AggregateRating', ratingValue: '4.9', reviewCount: '55' } };
const schemaFAQ = {
  '@context': 'https://schema.org', '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: "Quel taux de TVA pour les travaux de maçonnerie ?", acceptedAnswer: { '@type': 'Answer', text: "La maçonnerie en rénovation (logement +2 ans) est taxée à 10% de TVA. En construction neuve : 20%. InvoiceAgent applique automatiquement le bon taux selon le type de chantier." } },
    { '@type': 'Question', name: "Comment gérer les factures béton et matériaux d'un maçon ?", acceptedAnswer: { '@type': 'Answer', text: "InvoiceAgent extrait automatiquement les factures Point P, Lafarge, Holcim, Saint-Gobain depuis le chantier. Béton, parpaings, armatures, ferraillage — chaque ligne extraite en moins de 5 secondes par OCR IA." } },
    { '@type': 'Question', name: "Pourquoi analyser ses contrats de maçonnerie avant de signer ?", acceptedAnswer: { '@type': 'Answer', text: "Un contrat de maçonnerie sans clause de garantie décennale ou avec des pénalités de retard mal définies peut coûter très cher. InvoiceAgent détecte ces clauses manquantes et les risques financiers avant signature." } },
    { '@type': 'Question', name: "InvoiceAgent fonctionne-t-il pour les maçons avec plusieurs chantiers ?", acceptedAnswer: { '@type': 'Answer', text: "Oui. Le plan Business à 49€/mois permet de gérer plusieurs chantiers simultanément avec un suivi séparé des factures et dépenses par chantier." } },
  ],
};
const schemaBreadcrumb = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Accueil', item: BASE_URL }, { '@type': 'ListItem', position: 2, name: 'Facturation Maçon', item: PAGE_URL }] };
          ...
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="text-center lg:text-left">
            <motion.div variants={fadeInUp}>
              <Badge className="mb-6 px-4 py-2 bg-violet-100 text-violet-700 hover:bg-violet-200 border-0 text-sm font-medium">
                ...
                Pour maçons — factures béton et contrats de chantier
              </Badge>
            </motion.div>
            <motion.h1 variants={fadeInUp} className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              <span className="bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent">Facturation maçon</span>
              <br />
            ...
            <motion.p variants={fadeInUp} className="text-lg sm:text-xl text-slate-600 mb-6 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Un maçon indépendant reçoit en moyenne <strong>50 factures fournisseurs par mois</strong> — béton, parpaings, armatures, coffrages. InvoiceAgent les traite automatiquement par OCR IA depuis le chantier en moins de 5 secondes.
            </motion.p>
            <motion.div variants={fadeInUp} className="bg-red-50 border border-red-200 rounded-xl p-4 mb-8 text-left">
              <p className="text-sm font-semibold text-red-800 mb-1">🚨 Le risque que peu de maçons anticipent</p>
              <p className="text-sm text-red-700">Les contrats de maçonnerie sans clause de garantie décennale explicite ou avec des pénalités de retard mal définies peuvent exposer le maçon à des <strong>litiges de €10,000 à €50,000</strong>. InvoiceAgent analyse vos contrats avant que vous signiez.</p>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="flex flex-wrap items-center justify-center lg:justify-start gap-6 text-sm text-slate-500">
              {["Gratuit jusqu'à 5 factures/mois", 'Scan depuis le chantier', 'Contrats analysés par IA'].map((item) => (
          ...
          <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 1, delay: 0.3 }} className="relative">
            <div className="bg-white rounded-3xl shadow-2xl shadow-violet-600/20 p-6 border border-slate-100">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-slate-900">Maçon indépendant</p>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-4">
                  ...
                  <p className="text-2xl font-bold text-slate-900">€28,640</p>
                  <p className="text-xs text-emerald-600 mt-1">TVA calculée auto</p>
                </div>
              </div>
              <div className="space-y-3">
                {[
                  { client: 'Point P — Béton et parpaings', amount: '€8,420', status: 'Payée' },
                  { client: 'Lafarge Holcim — Ciment et mortier', amount: '€6,180', status: 'En attente' },
                  { client: 'Manutan — Ferraillage et armatures', amount: '€4,240', status: 'Payée' },
                ].map((item, i) => (
            ...
            <motion.div animate={{ y: [0, -10, 0] }} transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }} className="absolute -top-6 -right-6 bg-white rounded-2xl shadow-xl p-4 border border-slate-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-red-500 font-semibold">Garantie décennale</p>
                </div>
              </div>
            </motion.div>
            <motion.div animate={{ y: [0, 10, 0] }} transition={{ duration: 4, repeat: Infinity, ease: 'easeInOut', delay: 0.5 }} className="absolute -bottom-4 -left-4 bg-white rounded-2xl shadow-xl p-4 border border-slate-100">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-slate-500">rénovation</span>
              </div>
            </motion.div>
          </motion.div>
        </div>
...
function Features() {
  const features = [
    { icon: Zap, title: 'OCR factures béton et matériaux', description: "Scannez vos factures Point P, Lafarge, Holcim, Manutan depuis le chantier. Béton, parpaings, ciment, armatures — chaque ligne extraite en moins de 5 secondes, même sur bons de livraison à peine lisibles.", color: 'from-amber-400 to-orange-500' },
    { icon: HardHat, title: 'TVA 10% rénovation et 20% neuf', description: "Maçonnerie en logement +2 ans = TVA 10%. Construction neuve = TVA 20%. InvoiceAgent applique le bon taux automatiquement selon le chantier — aucune erreur sur votre déclaration mensuelle.", color: 'from-violet-400 to-purple-500' },
    { icon: FileText, title: 'Analyse contrats et marchés de travaux', description: "Uploadez votre marché de travaux ou contrat client avant signature. L'IA détecte les clauses de garantie décennale manquantes, les pénalités de retard, les conditions de réception et les frais cachés.", color: 'from-pink-400 to-rose-500' },
    ...
    { icon: Clock, title: 'Réconciliation bancaire CSV', description: "Importez votre relevé bancaire CSV. L'IA rapproche automatiquement les virements clients avec les chantiers facturés et vos achats fournisseurs béton et matériaux.", color: 'from-blue-400 to-indigo-500' },
    { icon: Calculator, title: 'Export FEC conforme DGFiP', description: "Générez votre FEC en un clic. Compatible Sage, EBP, Cegid. En cas de contrôle fiscal — fréquent dans le BTP — votre dossier est complet et structuré.", color: 'from-cyan-400 to-blue-500' },
  ];
  return (
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16 lg:mb-20">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 mb-6">
            Factures béton et contrats <span className="bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-transparent">gérés automatiquement</span>
          </h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">InvoiceAgent gère vos factures fournisseurs béton et vos contrats clients — les deux piliers de la comptabilité d'un maçon indépendant.</p>
        </AnimatedSection>
...
function HowItWorks() {
  const steps = [
    { number: '01', title: 'Scannez depuis le chantier', description: "Photographiez vos bons de livraison béton ou factures Point P avec votre smartphone. L'analyse démarre automatiquement.", icon: FileText },
    { number: '02', title: "L'IA extrait les données", description: "Fournisseur, SIRET, références matériaux, montants HT/TTC, TVA 10% ou 20% — extrait en moins de 5 secondes.", icon: Zap },
    { number: '03', title: 'Analysez vos marchés de travaux', description: "Uploadez votre contrat ou marché. L'IA détecte les clauses de garantie décennale manquantes et les risques financiers.", icon: FileSearch },
    { number: '04', title: 'Exportez pour votre comptable', description: "FEC conforme DGFiP ou CSV. Votre comptable BTP reçoit un fichier structuré — sans ressaisie.", icon: Calculator },
  ];
  return (
    <section className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16 lg:mb-20">
          ...
          <p className="text-slate-600 max-w-xl mx-auto">Moins de 5 secondes par facture béton. Moins de 30 secondes pour analyser un marché de travaux.</p>
        </AnimatedSection>
...
function Pricing() {
  const plans = [
    { name: 'Gratuit', price: '0', description: 'Pour tester sans risque', features: ['5 factures fournisseurs/mois', 'Scan smartphone chantier (OCR)', 'Suivi payé / impayé', 'Tableau de bord simple', 'Export PDF'], cta: 'Commencer gratuitement', popular: false, href: `${BASE_URL}/auth/login` },
    { name: 'Starter', price: '19', description: 'Pour maçons indépendants', features: ['100 factures / mois', 'TVA 10% et 20% automatique', 'Réconciliation bancaire CSV', 'Alertes factures impayées', 'Export CSV + PDF', 'Tableau de bord complet'], cta: 'Choisir Starter', popular: true, href: `${BASE_URL}/checkout?plan=starter` },
    { name: 'Pro', price: '29', description: 'Factures + marchés de travaux', features: ['Factures illimitées', 'IA correspondances bancaires', 'Export FEC conforme DGFiP', 'Analyse contrats (5/mois)', 'Détection garantie décennale', 'Pénalités de retard identifiées'], cta: 'Choisir Pro', popular: false, href: `${BASE_URL}/checkout?plan=pro` },
    { name: 'Business', price: '49', description: 'Entreprises maçonnerie multi-chantiers', features: ['Tout Pro inclus', 'Multi-chantiers illimité', 'Analyse contrats illimitée', 'Résumé intelligent', 'Historique sécurisé RGPD', 'Accompagnement personnalisé'], cta: 'Choisir Business', popular: false, href: `${BASE_URL}/checkout?plan=business` },
  ];
  return (
    ...
    <section id="demo" className="py-24 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Testez avec une vraie facture béton ou un marché de travaux</h2>
          <p className="text-lg text-violet-200 max-w-2xl mx-auto">Importez une facture fournisseur ou un contrat de maçonnerie — l'IA extrait et analyse tout en quelques secondes.</p>
        </AnimatedSection>
        ...
        <div className="grid grid-cols-3 gap-6 mt-10">
          {[{ value: '50', label: 'Factures/mois en moyenne', icon: FileText }, { value: '< 5s', label: 'Par facture traitée', icon: Zap }, { value: '€0', label: 'Pour commencer', icon: CheckCircle2 }].map((stat) => (
...
function FAQ() {
  const faqs = [
    { q: "Quel taux de TVA pour les travaux de maçonnerie ?", a: "La maçonnerie en rénovation (logement de plus de 2 ans) est taxée à 10% de TVA. En construction neuve ou locaux professionnels, le taux est de 20%. InvoiceAgent applique automatiquement le bon taux selon le chantier — sans erreur sur votre déclaration TVA." },
    { q: "Comment gérer les factures béton et matériaux d'un maçon ?", a: "InvoiceAgent extrait automatiquement les factures Point P, Lafarge, Holcim, Manutan depuis le chantier. Béton, parpaings, ciment, armatures, coffrages — chaque ligne est extraite en moins de 5 secondes par OCR IA, même sur bons de livraison à peine lisibles." },
    { q: "Pourquoi analyser ses contrats de maçonnerie avant de signer ?", a: "Un contrat de maçonnerie sans clause de garantie décennale explicite ou avec des pénalités de retard mal définies peut exposer le maçon à des litiges de €10,000 à €50,000. InvoiceAgent détecte ces clauses manquantes, les risques de responsabilité et les frais cachés avant que vous signiez." },
    { q: "InvoiceAgent fonctionne-t-il pour les maçons avec plusieurs chantiers ?", a: "Oui. Le plan Business à 49€/mois permet de gérer plusieurs chantiers simultanément avec un suivi séparé des factures et dépenses par chantier. Idéal pour les maçons qui gèrent 3 à 5 chantiers en parallèle." },
    { q: "Puis-je exporter vers mon expert-comptable BTP ?", a: "Oui. Export FEC natif compatible Sage, EBP et Cegid — les logiciels les plus utilisés par les experts-comptables spécialisés en BTP. Export CSV et PDF disponibles. Votre comptable reçoit un fichier propre sans ressaisie." },
  ];
  ...
  return (
    <section className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <AnimatedSection>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">Gérez vos factures béton et contrats depuis n'importe quel chantier</h2>
...
function InternalLinks() {
  const links = [
    ...
    { label: 'Facturation Carreleur', href: `${BASE_URL}/facturation-carreleur` },
...
export default function FacturationMacon() {
  return (
    <>
