...
export default function PageComponent() {
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      <Navigation />
      <Hero title="Logiciel TVA automatique pour PME : verification par IA" desc="100 factures verifiees manuellement = 8 heures perdues. InvoiceAgent automatise taux, VIES, mentions et calculs TVA en 5 secondes par facture." cta="Tester gratuitement" />
      <Demo title="Testez la verification TVA automatique maintenant" />
      <Pricing />
      ...
      <CTA title="Arretez de perdre 8 heures par mois sur la TVA" cta="Tester gratuitement" />
      <SharedFooter />
    </div>
  );
}
