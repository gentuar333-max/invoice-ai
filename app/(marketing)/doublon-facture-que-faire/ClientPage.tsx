...
export default function PageComponent() {
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      <Navigation />
      <Hero title="Doublon facture fournisseur paye deux fois : que faire" desc="12 800 euros de doublons payes par an en moyenne. InvoiceAgent detecte les doublons avant paiement et guide vers le remboursement." cta="Detecter mes doublons" />
      <Demo title="Detectez vos doublons maintenant" />
      <Pricing />
      ...
      <CTA title="Ne payez plus jamais une facture en double" cta="Detecter mes doublons" />
      <SharedFooter />
    </div>
  );
}
