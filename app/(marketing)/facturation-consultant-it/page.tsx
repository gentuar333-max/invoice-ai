...
import { FileText, Zap, Shield, Clock, CheckCircle2, ArrowRight, ChevronDown, Sparkles, Building2, Calculator, FileSearch, Code2, Server, Globe } from 'lucide-react';
...
const schemaSoftware = { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'InvoiceAgent — Facturation Consultant IT', applicationCategory: 'BusinessApplication', operatingSystem: 'Web, SaaS', url: PAGE_URL, offers: { '@type': 'AggregateOffer', lowPrice: '0', highPrice: '49', priceCurrency: 'EUR' }, aggregateRating: { '@type': 'AggregateRating', ratingValue: '4.9', reviewCount: '62' } };
const schemaFAQ = {
  '@context': 'https://schema.org', '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: "Comment fonctionne l'OCR IA pour les factures IT ?", acceptedAnswer: { '@type': 'Answer', text: "InvoiceAgent analyse vos factures fournisseurs IT (AWS, OVH, Microsoft, Slack, etc.) par OCR IA. En moins de 5 secondes, le nom du fournisseur, le SIRET, les montants HT/TTC et la TVA sont extraits automatiquement." } },
    { '@type': 'Question', name: "Mes données sont-elles sécurisées ?", acceptedAnswer: { '@type': 'Answer', text: "Oui. InvoiceAgent traite uniquement les données comptables — jamais le code source ou les données clients. Hébergement Frankfurt (UE), chiffrement AES-256, conformité RGPD totale." } },
    { '@type': 'Question', name: "Puis-je exporter vers mon comptable ?", acceptedAnswer: { '@type': 'Answer', text: "Oui. Export FEC natif compatible Sage, EBP et Cegid. Export CSV et PDF également disponibles. Votre comptable peut importer directement sans ressaisie." } },
    { '@type': 'Question', name: "Qu'est-ce que l'export FEC ?", acceptedAnswer: { '@type': 'Answer', text: "Le Fichier des Écritures Comptables (FEC) est le format standard exigé par la DGFiP en cas de contrôle fiscal. InvoiceAgent le génère automatiquement depuis vos factures traitées." } },
    { '@type': 'Question', name: "InvoiceAgent gère-t-il les factures SaaS en devise étrangère ?", acceptedAnswer: { '@type': 'Answer', text: "Oui. Les factures en USD (AWS, GitHub, Stripe) ou en GBP sont reconnues et converties automatiquement. Le taux de change est appliqué à la date de la facture." } },
  ],
};
const schemaBreadcrumb = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Accueil', item: BASE_URL }, { '@type': 'ListItem', position: 2, name: 'Facturation Consultant IT', item: PAGE_URL }] };
          ...
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="text-center lg:text-left">
            <motion.div variants={fadeInUp}>
              <Badge className="mb-6 px-4 py-2 bg-violet-100 text-violet-700 hover:bg-violet-200 border-0 text-sm font-medium">
                ...
                Solution comptable pour consultants IT et freelances tech
              </Badge>
            </motion.div>
            <motion.h1 variants={fadeInUp} className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              <span className="bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent">Facturation consultant IT</span>
              <br />
            ...
            <motion.p variants={fadeInUp} className="text-lg sm:text-xl text-slate-600 mb-8 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Automatisez le traitement de vos factures SaaS, hébergement cloud et sous-traitance. InvoiceAgent extrait les données par OCR IA — AWS, OVH, Microsoft, GitHub reconnus automatiquement. Export FEC conforme DGFiP.
            </motion.p>
            ...
            <motion.div variants={fadeInUp} className="flex flex-wrap items-center justify-center lg:justify-start gap-6 text-sm text-slate-500">
              {["Gratuit jusqu'à 5 factures/mois", 'Sans carte bancaire', 'RGPD — données en Europe'].map((item) => (
          ...
          <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 1, delay: 0.3 }} className="relative">
            <div className="bg-white rounded-3xl shadow-2xl shadow-violet-600/20 p-6 border border-slate-100">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-slate-900">Consultant IT indépendant</p>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="bg-gradient-to-br from-violet-50 to-indigo-50 rounded-2xl p-4">
                  <p className="text-sm text-slate-500 mb-1">Factures SaaS/mois</p>
                  <p className="text-2xl font-bold text-slate-900">34</p>
                  <p className="text-xs text-emerald-600 mt-1">Traitées auto</p>
                </div>
                <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-4">
                  <p className="text-sm text-slate-500 mb-1">Total dépenses IT</p>
              ...
              <div className="space-y-3">
                {[
                  { client: 'Amazon Web Services EMEA', amount: '€1,840', status: 'Payée' },
                  { client: 'OVHcloud SAS', amount: '€320', status: 'Payée' },
                  { client: 'Microsoft Ireland Operations', amount: '€890', status: 'En attente' },
                ].map((item, i) => (
                  <motion.div key={i} initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.8 + i * 0.1 }} className="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500">Facture SaaS / Cloud</p>
                      </div>
                    </div>
            ...
            <motion.div animate={{ y: [0, -10, 0] }} transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }} className="absolute -top-6 -right-6 bg-white rounded-2xl shadow-xl p-4 border border-slate-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-slate-900">AWS reconnu</p>
                  <p className="text-xs text-slate-500">SIRET extrait auto</p>
                </div>
              </div>
            </motion.div>
            <motion.div animate={{ y: [0, 10, 0] }} transition={{ duration: 4, repeat: Infinity, ease: 'easeInOut', delay: 0.5 }} className="absolute -bottom-4 -left-4 bg-white rounded-2xl shadow-xl p-4 border border-slate-100">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-slate-900">USD → EUR auto</span>
              </div>
            </motion.div>
          </motion.div>
        </div>
...
function Features() {
  const features = [
    { icon: Server, title: 'Fournisseurs SaaS reconnus', description: "AWS, OVH, Microsoft Azure, GitHub, Slack, Notion, Linear — InvoiceAgent reconnaît automatiquement vos fournisseurs IT et extrait leurs données en moins de 5 secondes.", color: 'from-amber-400 to-orange-500' },
    { icon: Globe, title: 'Factures en devises étrangères', description: "Les factures AWS en USD ou GitHub en GBP sont converties automatiquement au taux de change de la date de facturation. Aucune saisie manuelle.", color: 'from-violet-400 to-purple-500' },
    { icon: Shield, title: 'RGPD — aucun code source collecté', description: "InvoiceAgent traite uniquement les données comptables. Aucun accès à votre code source, données clients ou configurations techniques. Hébergement Frankfurt (UE).", color: 'from-emerald-400 to-teal-500' },
    { icon: Clock, title: 'Réconciliation bancaire CSV', description: "Importez votre relevé bancaire CSV. L'IA rapproche automatiquement les prélèvements SaaS et virements clients avec les factures traitées.", color: 'from-blue-400 to-indigo-500' },
    { icon: Code2, title: 'Analyse contrats SaaS et ESN', description: "Uploadez vos contrats de prestation ou accords SaaS. L'IA détecte les clauses d'exclusivité, de non-concurrence, de propriété intellectuelle et les pénalités cachées.", color: 'from-pink-400 to-rose-500' },
    { icon: Calculator, title: 'Export FEC conforme DGFiP', description: "Générez votre FEC en un clic. Compatible Sage, EBP, Cegid. En cas de contrôle fiscal, votre dossier est complet et structuré.", color: 'from-cyan-400 to-blue-500' },
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16 lg:mb-20">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 mb-6">
            Conçu pour les
            <span className="bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-transparent"> consultants IT français</span>
          </h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Une suite d'outils adaptée aux spécificités comptables des freelances tech et ESN françaises.
          </p>
        </AnimatedSection>
...
function HowItWorks() {
  const steps = [
    { number: '01', title: 'Importez vos factures SaaS', description: "Glissez vos factures AWS, OVH, Microsoft ou sous-traitance PDF. L'analyse démarre automatiquement.", icon: FileText },
    { number: '02', title: "L'IA extrait les données", description: "Fournisseur, montants HT/TTC, TVA, devise extraits en moins de 5 secondes — même en anglais.", icon: Zap },
    { number: '03', title: 'Vérifiez et validez', description: "Contrôlez les données extraites et enregistrez en un clic. Les doublons et abonnements en double sont détectés.", icon: CheckCircle2 },
    { number: '04', title: 'Exportez pour votre comptable', description: "Générez votre FEC conforme DGFiP ou exportez en CSV. Votre comptable reçoit un fichier structuré.", icon: Calculator },
  ];
    ...
    <section className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16 lg:mb-20">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 mb-6">
            Opérationnel en
            <span className="bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-transparent"> 4 étapes simples</span>
          </h2>
        </AnimatedSection>
...
function Pricing() {
  const plans = [
    { name: 'Gratuit', price: '0', description: 'Pour commencer sans risque', features: ['5 factures fournisseurs/mois', 'Scan via smartphone (OCR)', 'Suivi payé / impayé', 'Tableau de bord simple', 'Export PDF'], cta: 'Commencer gratuitement', popular: false, href: `${BASE_URL}/auth/login` },
    { name: 'Starter', price: '19', description: 'Pour consultants indépendants', features: ['100 factures / mois', 'Calcul TVA automatique', 'Réconciliation bancaire CSV', 'Alertes factures impayées', 'Export CSV + PDF', 'Tableau de bord complet'], cta: 'Choisir Starter', popular: true, href: `${BASE_URL}/checkout?plan=starter` },
    { name: 'Pro', price: '29', description: 'Automatisation avancée', features: ['Factures illimitées', 'IA correspondances bancaires', 'Export FEC conforme DGFiP', 'Analyse contrats SaaS (5/mois)', 'Détection clauses à risque', 'Frais cachés identifiés'], cta: 'Choisir Pro', popular: false, href: `${BASE_URL}/checkout?plan=pro` },
    { name: 'Business', price: '49', description: 'ESN et cabinets IT', features: ['Tout Pro inclus', 'Multi-consultants simplifié', 'Analyse contrats illimitée', 'Résumé intelligent', 'Historique sécurisé RGPD', 'Accompagnement personnalisé'], cta: 'Choisir Business', popular: false, href: `${BASE_URL}/checkout?plan=business` },
  ];
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
            Testez avec une facture AWS ou OVH
          </h2>
          <p className="text-lg text-violet-200 max-w-2xl mx-auto">
            Importez une facture fournisseur IT ou un contrat SaaS — l'IA extrait toutes les données en quelques secondes.
          </p>
        </AnimatedSection>
        ...
        <div className="grid grid-cols-3 gap-6 mt-10">
          {[
            ...
            { value: '100%', label: 'Données sécurisées EU', icon: Shield },
          ].map((stat) => (
...
function FAQ() {
  const faqs = [
    { q: "Comment fonctionne l'OCR IA pour les factures IT ?", a: "InvoiceAgent analyse vos factures fournisseurs IT par OCR IA — AWS, OVH, Microsoft Azure, GitHub, Slack et autres sont reconnus automatiquement. En moins de 5 secondes, le nom du fournisseur, le SIRET, les montants HT/TTC et la TVA sont extraits. Même les factures en anglais ou en USD sont traitées correctement." },
    { q: "Mes données sont-elles sécurisées ?", a: "InvoiceAgent traite uniquement les données comptables de vos factures — jamais votre code source, vos configurations techniques ou vos données clients. L'hébergement est à Frankfurt (UE) avec chiffrement AES-256. Conformité RGPD totale. Aucune donnée n'est revendue ou partagée avec des tiers." },
    { q: "Puis-je exporter vers mon comptable ?", a: "Oui. Export FEC natif compatible Sage, EBP et Cegid — les logiciels les plus utilisés par les experts-comptables spécialisés en freelances tech. Export CSV et PDF également disponibles sur tous les plans." },
    { q: "Qu'est-ce que l'export FEC ?", a: "Le Fichier des Écritures Comptables (FEC) est le format standard exigé par la DGFiP en cas de contrôle fiscal. Depuis 2014, toute entreprise doit être en mesure de le fournir. InvoiceAgent le génère automatiquement depuis vos factures traitées — sans intervention manuelle." },
    { q: "InvoiceAgent gère-t-il les factures SaaS en devise étrangère ?", a: "Oui. Les factures AWS en USD, GitHub en USD ou Cloudflare en USD sont reconnues et converties automatiquement en euros au taux de change de la date de facturation. Le montant TVA est calculé selon les règles françaises de TVA sur achats intracommunautaires." },
    { q: "Fonctionne-t-il pour les ESN et cabinets IT multi-consultants ?", a: "Oui, dès le plan Business à 49€/mois. InvoiceAgent gère les structures multi-consultants avec FEC séparé par entité et tableaux de bord consolidés. Idéal pour les ESN et cabinets de conseil IT avec plusieurs collaborateurs." },
  ];
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <AnimatedSection>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">
            Automatisez la comptabilité de votre activité IT
          </h2>
          ...
          <p className="text-violet-200 text-sm mb-10">
            Une question ? Contactez-nous : <a href="mailto:contact@invoiceagent.fr" className="text-white font-semibold underline underline-offset-2">contact@invoiceagent.fr</a>
          </p>
...
export default function FacturationConsultantIT() {
  return (
    <>
