...
import { FileText, Zap, Shield, Clock, CheckCircle2, ArrowRight, ChevronDown, Sparkles, Building2, Calculator, FileSearch, Hammer, TreePine, AlertTriangle } from 'lucide-react';
...
const schemaSoftware = { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'InvoiceAgent — Facturation Menuisier', applicationCategory: 'BusinessApplication', operatingSystem: 'Web, SaaS', url: PAGE_URL, offers: { '@type': 'AggregateOffer', lowPrice: '0', highPrice: '49', priceCurrency: 'EUR' }, aggregateRating: { '@type': 'AggregateRating', ratingValue: '4.8', reviewCount: '52' } };
const schemaFAQ = {
  '@context': 'https://schema.org', '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: "Quel taux de TVA pour les travaux de menuiserie ?", acceptedAnswer: { '@type': 'Answer', text: "Les travaux de menuiserie en rénovation (logement +2 ans) sont taxés à 10% de TVA. En construction neuve : 20%. InvoiceAgent applique automatiquement le bon taux selon le chantier." } },
    { '@type': 'Question', name: "Comment gérer les factures bois et matériaux d'un menuisier ?", acceptedAnswer: { '@type': 'Answer', text: "InvoiceAgent extrait automatiquement les factures Silverwood, Bois Massif, Leroy Merlin Pro et autres fournisseurs bois. Chaque facture est traitée en moins de 5 secondes par OCR IA depuis votre smartphone." } },
    { '@type': 'Question', name: "Pourquoi analyser ses contrats de pose avant de signer ?", acceptedAnswer: { '@type': 'Answer', text: "Un contrat de menuiserie sans clause de réception formelle expose le menuisier à des litiges clients coûteux. L'IA InvoiceAgent détecte ces clauses manquantes, les pénalités de retard et les frais cachés avant signature." } },
    { '@type': 'Question', name: "InvoiceAgent fonctionne-t-il depuis l'atelier ou le chantier ?", acceptedAnswer: { '@type': 'Answer', text: "Oui. Photographiez une facture fournisseur depuis votre atelier ou chantier. L'IA extrait toutes les données en moins de 5 secondes, même sur papier froissé ou en mauvaise lumière." } },
  ],
};
const schemaBreadcrumb = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Accueil', item: BASE_URL }, { '@type': 'ListItem', position: 2, name: 'Facturation Menuisier', item: PAGE_URL }] };
          ...
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="text-center lg:text-left">
            <motion.div variants={fadeInUp}>
              <Badge className="mb-6 px-4 py-2 bg-violet-100 text-violet-700 hover:bg-violet-200 border-0 text-sm font-medium">
                ...
                Pour menuisiers — factures bois et contrats de pose
              </Badge>
            </motion.div>
            <motion.h1 variants={fadeInUp} className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              <span className="bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent">Facturation menuisier</span>
              <br />
            ...
            <motion.p variants={fadeInUp} className="text-lg sm:text-xl text-slate-600 mb-6 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Un menuisier indépendant reçoit en moyenne <strong>40 factures fournisseurs par mois</strong> — bois, quincaillerie, sous-traitance. InvoiceAgent les traite automatiquement par OCR IA depuis votre atelier ou chantier.
            </motion.p>
            <motion.div variants={fadeInUp} className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-8 text-left">
              <p className="text-sm font-semibold text-amber-800 mb-1">⚠ Le risque que personne ne vous dit</p>
              <p className="text-sm text-amber-700">Un contrat de pose sans clause de réception formelle peut vous exposer à des litiges clients de <strong>€5,000 à €20,000</strong>. InvoiceAgent analyse vos contrats avant que vous signiez.</p>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="flex flex-wrap items-center justify-center lg:justify-start gap-6 text-sm text-slate-500">
              {["Gratuit jusqu'à 5 factures/mois", 'Scan depuis atelier ou chantier', 'Contrats analysés par IA'].map((item) => (
            ...
            <div className="bg-white rounded-3xl shadow-2xl shadow-violet-600/20 p-6 border border-slate-100">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-slate-900">Menuisier indépendant</p>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-4">
                  <p className="text-sm text-slate-500 mb-1">Total achats bois HT</p>
                  <p className="text-2xl font-bold text-slate-900">€14,820</p>
                  <p className="text-xs text-emerald-600 mt-1">TVA calculée auto</p>
                </div>
              </div>
              <div className="space-y-3">
                {[
                  { client: 'Silverwood — Bois massif chêne', amount: '€3,240', status: 'Payée' },
                  { client: 'Bois Massif — Panneaux MDF', amount: '€1,890', status: 'En attente' },
                  { client: 'Quincaillerie Pro — Ferrures', amount: '€640', status: 'Payée' },
                ].map((item, i) => (
            ...
            <motion.div animate={{ y: [0, -10, 0] }} transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }} className="absolute -top-6 -right-6 bg-white rounded-2xl shadow-xl p-4 border border-slate-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-red-500 font-semibold">Clause risque détectée</p>
                </div>
              </div>
            </motion.div>
...
function Features() {
  const features = [
    { icon: Zap, title: 'OCR factures bois et matériaux', description: "Scannez vos factures Silverwood, Bois Massif, Leroy Merlin Pro, Point P Bois depuis l'atelier. Fournisseur, SIRET, montants et TVA extraits en moins de 5 secondes — même sur bon de livraison froissé.", color: 'from-amber-400 to-orange-500' },
    { icon: TreePine, title: 'TVA 10% rénovation et 20% neuf', description: "Menuiserie en logement +2 ans = TVA 10%. Construction neuve = TVA 20%. InvoiceAgent applique le bon taux automatiquement selon le type de chantier, sans que vous ayez à vérifier.", color: 'from-violet-400 to-purple-500' },
    { icon: FileText, title: 'Analyse contrats de pose et fourniture', description: "Uploadez votre devis accepté ou contrat client avant de démarrer. L'IA détecte les clauses de réception manquantes, les pénalités de retard, les exclusions de garantie et les frais cachés — avant qu'il soit trop tard.", color: 'from-pink-400 to-rose-500' },
    ...
    { icon: Clock, title: 'Réconciliation bancaire CSV', description: "Importez votre relevé bancaire CSV. L'IA rapproche automatiquement les virements clients avec les chantiers facturés et vos achats fournisseurs bois.", color: 'from-blue-400 to-indigo-500' },
    { icon: Calculator, title: 'Export FEC conforme DGFiP', description: "Générez votre FEC en un clic. Compatible Sage, EBP, Cegid. En cas de contrôle fiscal, votre dossier est complet et structuré. Votre comptable gagne du temps, vous économisez.", color: 'from-cyan-400 to-blue-500' },
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16 lg:mb-20">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            InvoiceAgent gère vos factures fournisseurs bois et vos contrats clients — les deux problèmes comptables que chaque menuisier indépendant rencontre chaque semaine.
          </p>
        </AnimatedSection>
...
function HowItWorks() {
  const steps = [
    { number: '01', title: 'Scannez depuis l\'atelier', description: "Photographiez vos factures bois ou bons de livraison avec votre smartphone. L'analyse démarre immédiatement.", icon: FileText },
    ...
    { number: '03', title: 'Analysez vos contrats', description: "Uploadez votre contrat client avant signature. L'IA détecte les clauses manquantes et risques financiers.", icon: FileSearch },
    { number: '04', title: 'Exportez pour votre comptable', description: "FEC conforme DGFiP ou CSV. Votre comptable reçoit un fichier propre. Vous gagnez du temps et de l'argent.", icon: Calculator },
  ];
    ...
    <section className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16 lg:mb-20">
          ...
          <p className="text-slate-600 max-w-xl mx-auto">Moins de 2 minutes pour traiter une facture. Moins de 30 secondes pour analyser un contrat.</p>
        </AnimatedSection>
...
function Pricing() {
  const plans = [
    { name: 'Gratuit', price: '0', description: 'Pour tester sans risque', features: ['5 factures fournisseurs/mois', 'Scan smartphone atelier/chantier', 'Suivi payé / impayé', 'Tableau de bord simple', 'Export PDF'], cta: 'Commencer gratuitement', popular: false, href: `${BASE_URL}/auth/login` },
    { name: 'Starter', price: '19', description: 'Pour menuisiers indépendants', features: ['100 factures / mois', 'TVA 10% et 20% automatique', 'Réconciliation bancaire CSV', 'Alertes factures impayées', 'Export CSV + PDF', 'Tableau de bord complet'], cta: 'Choisir Starter', popular: true, href: `${BASE_URL}/checkout?plan=starter` },
    { name: 'Pro', price: '29', description: 'Factures + contrats de pose', features: ['Factures illimitées', 'IA correspondances bancaires', 'Export FEC conforme DGFiP', 'Analyse contrats (5/mois)', 'Détection clauses réception', 'Pénalités de retard identifiées'], cta: 'Choisir Pro', popular: false, href: `${BASE_URL}/checkout?plan=pro` },
    { name: 'Business', price: '49', description: 'Ateliers menuiserie multi-chantiers', features: ['Tout Pro inclus', 'Multi-chantiers illimité', 'Analyse contrats illimitée', 'Résumé intelligent', 'Historique sécurisé RGPD', 'Accompagnement personnalisé'], cta: 'Choisir Business', popular: false, href: `${BASE_URL}/checkout?plan=business` },
  ];
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
            Testez avec une vraie facture bois ou un contrat de pose
          </h2>
          <p className="text-lg text-violet-200 max-w-2xl mx-auto">
            Importez une facture fournisseur ou un contrat client — l'IA extrait et analyse tout en quelques secondes. Voyez exactement ce qu'InvoiceAgent détecte sur vos documents.
          </p>
        </AnimatedSection>
        ...
        <div className="grid grid-cols-3 gap-6 mt-10">
          {[
            { value: '40', label: 'Factures/mois en moyenne', icon: FileText },
...
function FAQ() {
  const faqs = [
    { q: "Quel taux de TVA pour les travaux de menuiserie ?", a: "Les travaux de menuiserie en rénovation (logement de plus de 2 ans) sont taxés à 10% de TVA. En construction neuve, le taux est de 20%. InvoiceAgent applique automatiquement le bon taux selon le chantier — sans erreur possible." },
    { q: "Comment gérer les factures bois et matériaux d'un menuisier ?", a: "InvoiceAgent extrait automatiquement les factures Silverwood, Bois Massif, Leroy Merlin Pro et autres fournisseurs bois. Chaque facture est traitée en moins de 5 secondes par OCR IA depuis votre smartphone — depuis l'atelier ou le chantier." },
    { q: "Pourquoi analyser ses contrats de pose avant de signer ?", a: "Un contrat de menuiserie sans clause de réception formelle expose le menuisier à des litiges clients de €5,000 à €20,000. L'IA InvoiceAgent détecte ces clauses manquantes, les pénalités de retard cachées et les exclusions de garantie abusives — avant que vous signiez." },
    { q: "InvoiceAgent fonctionne-t-il depuis l'atelier ou le chantier ?", a: "Oui. L'interface est optimisée pour smartphone. Photographiez une facture fournisseur depuis votre atelier ou chantier — l'IA extrait toutes les données en moins de 5 secondes, même sur papier froissé ou en mauvaise lumière." },
    { q: "Comment exporter vers mon expert-comptable ?", a: "Export FEC natif compatible Sage, EBP et Cegid. Export CSV et PDF disponibles. Votre expert-comptable spécialisé artisans reçoit un fichier propre et structuré — sans ressaisie manuelle." },
  ];
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <AnimatedSection>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">
            Arrêtez de perdre du temps sur vos factures bois
          </h2>
          <p className="text-lg sm:text-xl text-violet-100 mb-4 max-w-2xl mx-auto">
            5 factures gratuites — sans carte bancaire, sans installation. Opérationnel depuis votre atelier en 2 minutes.
          </p>
...
export default function FacturationMenuisier() {
  return (
    <>
