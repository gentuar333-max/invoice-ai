...
export default function PageComponent() {
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      <Navigation />
      <Hero title="Frais caches facture fournisseur : comment les detecter" desc="8 500 euros de frais caches acceptes sans verification chaque annee. InvoiceAgent analyse chaque ligne et detecte les majorations non contractuelles." cta="Scanner mes factures" />
      <Demo title="Scannez vos factures pour detecter les frais caches" />
      <Pricing />
      ...
      <CTA title="Arretez de payer des frais que vous n avez pas acceptes" cta="Scanner mes factures" />
      <SharedFooter />
    </div>
  );
}
