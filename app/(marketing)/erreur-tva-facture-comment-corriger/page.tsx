...
export const metadata: Metadata = {
  ...
  description: "Une erreur TVA non corrigee entraine jusqu'a 40% de majoration fiscale. InvoiceAgent detecte erreur en 5 secondes et guide vers la facture rectificative.",
