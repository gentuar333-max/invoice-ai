...
import { FileText, Zap, Shield, Clock, CheckCircle2, ArrowRight, ChevronDown, Sparkles, Building2, Calculator, FileSearch, Wrench, Droplets, AlertTriangle } from 'lucide-react';
...
const schemaSoftware = { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'InvoiceAgent — Facturation Plombier', applicationCategory: 'BusinessApplication', operatingSystem: 'Web, SaaS', url: PAGE_URL, offers: { '@type': 'AggregateOffer', lowPrice: '0', highPrice: '49', priceCurrency: 'EUR' }, aggregateRating: { '@type': 'AggregateRating', ratingValue: '4.8', reviewCount: '44' } };
const schemaFAQ = {
  '@context': 'https://schema.org', '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: "Quel taux de TVA pour les travaux de plomberie ?", acceptedAnswer: { '@type': 'Answer', text: "Les travaux de plomberie dans des logements de plus de 2 ans bénéficient du taux réduit de 10%. Pour les constructions neuves, le taux normal de 20% s'applique. InvoiceAgent détecte automatiquement le bon taux." } },
    { '@type': 'Question', name: "Comment scanner les factures fournisseurs depuis un chantier ?", acceptedAnswer: { '@type': 'Answer', text: "Photographiez votre facture fournisseur avec votre smartphone depuis le chantier. InvoiceAgent extrait fournisseur, SIRET, montants et TVA en moins de 5 secondes." } },
    { '@type': 'Question', name: "Comment analyser un contrat de prestation plomberie ?", acceptedAnswer: { '@type': 'Answer', text: "Uploadez votre contrat ou devis accepté. L'IA détecte les clauses de responsabilité, les pénalités de retard, les conditions de paiement et les frais cachés avant que vous signiez." } },
    { '@type': 'Question', name: "InvoiceAgent fonctionne-t-il pour les plombiers chauffagistes ?", acceptedAnswer: { '@type': 'Answer', text: "Oui. InvoiceAgent gère les factures de tous les fournisseurs sanitaires et chauffage — Rexel, Sonepar, Saint-Gobain, Ceveo, Cedeo — et leurs spécificités TVA." } },
  ],
};
const schemaBreadcrumb = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Accueil', item: BASE_URL }, { '@type': 'ListItem', position: 2, name: 'Facturation Plombier', item: PAGE_URL }] };
          ...
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="text-center lg:text-left">
            <motion.div variants={fadeInUp}>
              <Badge className="mb-6 px-4 py-2 bg-violet-100 text-violet-700 hover:bg-violet-200 border-0 text-sm font-medium">
                ...
                Solution pour plombiers et chauffagistes indépendants
              </Badge>
            </motion.div>
            <motion.h1 variants={fadeInUp} className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              <span className="bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent">Facturation plombier</span>
              <br />
            ...
            <motion.p variants={fadeInUp} className="text-lg sm:text-xl text-slate-600 mb-8 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Scannez vos factures fournisseurs sanitaires depuis le chantier et analysez vos contrats de prestation. InvoiceAgent extrait les données par OCR IA — TVA 10% rénovation et 20% neuf gérées automatiquement.
            </motion.p>
            ...
            <motion.div variants={fadeInUp} className="flex flex-wrap items-center justify-center lg:justify-start gap-6 text-sm text-slate-500">
              {["Gratuit jusqu'à 5 factures/mois", 'Scan smartphone chantier', 'TVA 10% et 20% automatique'].map((item) => (
            ...
            <div className="bg-white rounded-3xl shadow-2xl shadow-violet-600/20 p-6 border border-slate-100">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-slate-900">Plombier chauffagiste</p>
              ...
              <div className="space-y-3">
                {[
                  { client: 'Cedeo — Sanitaires et robinetterie', amount: '€2,840', status: 'Payée' },
                  { client: 'Ceveo — Chaudières et pompes', amount: '€4,120', status: 'En attente' },
                  { client: 'Point P — Tuyaux et raccords', amount: '€1,680', status: 'Payée' },
                ].map((item, i) => (
            ...
            <motion.div animate={{ y: [0, -10, 0] }} transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }} className="absolute -top-6 -right-6 bg-white rounded-2xl shadow-xl p-4 border border-slate-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">Pénalités détectées</p>
                </div>
              </div>
            </motion.div>
...
function Features() {
  const features = [
    { icon: Zap, title: 'OCR factures sanitaires et chauffage', description: "Scannez vos factures Cedeo, Ceveo, Point P, Saint-Gobain depuis le chantier. Fournisseur, SIRET, montants HT/TTC et TVA extraits en moins de 5 secondes.", color: 'from-amber-400 to-orange-500' },
    { icon: Droplets, title: 'TVA 10% rénovation et 20% neuf', description: "Plomberie en logement ancien = TVA 10%. Construction neuve = TVA 20%. InvoiceAgent applique automatiquement le bon taux selon le type de chantier indiqué sur la facture.", color: 'from-violet-400 to-purple-500' },
    { icon: FileText, title: 'Analyse contrats de prestation', description: "Uploadez vos devis acceptés ou contrats clients. L'IA identifie les clauses de garantie décennale, les pénalités de retard, les conditions de paiement et les exclusions de responsabilité.", color: 'from-pink-400 to-rose-500' },
    ...
    { icon: Clock, title: 'Réconciliation bancaire CSV', description: "Importez votre relevé bancaire. L'IA rapproche automatiquement les virements clients avec les chantiers facturés et les achats fournisseurs.", color: 'from-blue-400 to-indigo-500' },
    { icon: Calculator, title: 'Export FEC conforme DGFiP', description: "Générez votre FEC en un clic. Compatible Sage, EBP, Cegid. Votre expert-comptable spécialisé artisans reçoit un fichier structuré et propre.", color: 'from-cyan-400 to-blue-500' },
  ];
    ...
    <section id="features" className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16 lg:mb-20">
          ...
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">InvoiceAgent gère vos factures fournisseurs et vos contrats clients — les deux outils essentiels pour un plombier indépendant.</p>
        </AnimatedSection>
...
function HowItWorks() {
  const steps = [
    { number: '01', title: 'Scannez depuis le chantier', description: "Photographiez vos factures Cedeo ou Ceveo avec votre smartphone. L'analyse démarre automatiquement.", icon: FileText },
    { number: '02', title: "L'IA extrait les données", description: "Fournisseur, SIRET, montants HT/TTC, TVA 10% ou 20% — extrait en moins de 5 secondes.", icon: Zap },
    { number: '03', title: 'Analysez vos contrats', description: "Uploadez votre contrat client. L'IA identifie les clauses risquées et pénalités avant exécution.", icon: FileSearch },
    { number: '04', title: 'Exportez pour votre comptable', description: "FEC conforme DGFiP ou CSV. Votre comptable reçoit un fichier propre et structuré.", icon: Calculator },
  ];
...
function Pricing() {
  const plans = [
    ...
    { name: 'Starter', price: '19', description: 'Pour plombiers indépendants', features: ['100 factures / mois', 'TVA 10% et 20% automatique', 'Réconciliation bancaire CSV', 'Alertes factures impayées', 'Export CSV + PDF', 'Tableau de bord complet'], cta: 'Choisir Starter', popular: true, href: `${BASE_URL}/checkout?plan=starter` },
    { name: 'Pro', price: '29', description: 'Factures + contrats chantier', features: ['Factures illimitées', 'IA correspondances bancaires', 'Export FEC conforme DGFiP', 'Analyse contrats (5/mois)', 'Détection clauses garantie décennale', 'Pénalités de retard identifiées'], cta: 'Choisir Pro', popular: false, href: `${BASE_URL}/checkout?plan=pro` },
    { name: 'Business', price: '49', description: 'Entreprises plomberie multi-chantiers', features: ['Tout Pro inclus', 'Multi-chantiers illimité', 'Analyse contrats illimitée', 'Résumé intelligent', 'Historique sécurisé RGPD', 'Accompagnement personnalisé'], cta: 'Choisir Business', popular: false, href: `${BASE_URL}/checkout?plan=business` },
  ];
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
            Testez avec une facture Cedeo ou un contrat de chantier
          </h2>
          <p className="text-lg text-violet-200 max-w-2xl mx-auto">
            Importez une facture fournisseur sanitaire ou un contrat de prestation — l'IA extrait et analyse tout en quelques secondes.
          </p>
        </AnimatedSection>
...
function FAQ() {
  const faqs = [
    { q: "Quel taux de TVA pour les travaux de plomberie ?", a: "Les travaux de plomberie dans des logements achevés depuis plus de 2 ans bénéficient du taux réduit de TVA à 10%. Pour les constructions neuves et les locaux professionnels, le taux normal de 20% s'applique. InvoiceAgent extrait automatiquement le taux mentionné sur chaque facture fournisseur et l'intègre correctement dans votre comptabilité." },
    { q: "Comment scanner les factures fournisseurs depuis un chantier ?", a: "Photographiez votre facture Cedeo, Ceveo, Point P ou Saint-Gobain avec votre smartphone depuis n'importe quel chantier. L'IA extrait le fournisseur, le SIRET, les montants HT/TTC et la TVA en moins de 5 secondes — même en mauvaise luminosité ou si la facture est froissée." },
    { q: "Comment analyser un contrat de prestation plomberie ?", a: "Uploadez votre devis accepté ou contrat de prestation dans InvoiceAgent. L'IA détecte automatiquement les clauses de garantie décennale, les pénalités de retard de paiement, les conditions de résiliation et les frais cachés. Vous recevez un résumé clair avant d'exécuter le chantier." },
    { q: "InvoiceAgent fonctionne-t-il pour les plombiers chauffagistes ?", a: "Oui. InvoiceAgent gère les factures de tous les fournisseurs sanitaires et chauffage — Cedeo, Ceveo, Rexel, Point P, Saint-Gobain — et leurs spécificités de TVA. Les équipements de chauffage (chaudières, pompes à chaleur) sont correctement classifiés." },
    { q: "Puis-je exporter vers mon expert-comptable ?", a: "Oui. Export FEC natif compatible Sage, EBP et Cegid. Export CSV et PDF disponibles. Votre expert-comptable spécialisé en artisans du bâtiment peut importer directement sans ressaisie manuelle." },
  ];
...
export default function FacturationPlombier() {
  return (
    <>
