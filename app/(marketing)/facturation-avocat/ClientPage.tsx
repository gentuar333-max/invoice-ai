...
import { FileText, Zap, Shield, Clock, CheckCircle2, ArrowRight, ChevronDown, Sparkles, Scale, BookOpen, AlertTriangle, Calculator, FileSearch, Building2 } from 'lucide-react';
...
const schemaSoftware = { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'InvoiceAgent — Facturation Avocat', applicationCategory: 'BusinessApplication', operatingSystem: 'Web, SaaS', url: PAGE_URL, offers: { '@type': 'AggregateOffer', lowPrice: '0', highPrice: '49', priceCurrency: 'EUR' }, aggregateRating: { '@type': 'AggregateRating', ratingValue: '4.9', reviewCount: '43' } };
const schemaFAQ = {
  '@context': 'https://schema.org', '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: "Les avocats sont-ils soumis à la TVA ?", acceptedAnswer: { '@type': 'Answer', text: "Oui. Les honoraires d'avocat sont soumis à la TVA au taux normal de 20%, sauf certaines missions d'aide juridictionnelle exonérées. InvoiceAgent gère automatiquement ces distinctions." } },
    { '@type': 'Question', name: "Comment gérer les honoraires et les débours ?", acceptedAnswer: { '@type': 'Answer', text: "InvoiceAgent extrait et classe automatiquement les honoraires, les débours et les frais refacturables. Chaque dépense est catégorisée selon les règles comptables des cabinets d'avocats." } },
    { '@type': 'Question', name: "InvoiceAgent est-il conforme aux règles déontologiques des avocats ?", acceptedAnswer: { '@type': 'Answer', text: "InvoiceAgent traite uniquement les données comptables. Aucune donnée confidentielle client n'est collectée. Hébergement Frankfurt (UE), conformité RGPD totale." } },
...
const schemaBreadcrumb = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Accueil', item: BASE_URL }, { '@type': 'ListItem', position: 2, name: 'Facturation Avocat', item: PAGE_URL }] };
          ...
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="text-center lg:text-left">
            <motion.div variants={fadeInUp}>
              <Badge className="mb-6 px-4 py-2 bg-violet-100 text-violet-700 hover:bg-violet-200 border-0 text-sm font-medium">
                ...
                Solution comptable pour cabinets d'avocats
              </Badge>
            </motion.div>
            <motion.h1 variants={fadeInUp} className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              <span className="bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent">Facturation avocat</span>
              <br />
            ...
            <motion.p variants={fadeInUp} className="text-lg sm:text-xl text-slate-600 mb-8 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Automatisez la gestion des honoraires, débours et factures fournisseurs de votre cabinet. InvoiceAgent extrait les données par OCR IA — TVA 20% gérée automatiquement, export FEC conforme DGFiP.
            </motion.p>
            ...
            <div className="bg-white rounded-3xl shadow-2xl shadow-violet-600/20 p-6 border border-slate-100">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-slate-900">Cabinet d'avocats</p>
              ...
              <div className="space-y-3">
                {[
                  { client: 'Dossier Dupont & Associés', amount: '€12,000', status: 'Payée' },
                  { client: 'Contentieux Martin SA', amount: '€8,500', status: 'En attente' },
                  { client: 'Conseil juridique Bernard', amount: '€6,200', status: 'Payée' },
                ].map((item, i) => (
                  <motion.div key={i} initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.8 + i * 0.1 }} className="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500">Honoraires</p>
                      </div>
                    </div>
...
function Features() {
  const features = [
    { icon: Zap, title: 'OCR factures fournisseurs', description: "Importez vos factures fournisseurs et prestataires. L'IA extrait automatiquement fournisseur, SIRET, montants HT/TTC et TVA en moins de 5 secondes.", color: 'from-amber-400 to-orange-500' },
    { icon: Scale, title: 'Gestion TVA cabinet avocat', description: "TVA 20% sur honoraires, exonération aide juridictionnelle, débours refacturables — InvoiceAgent gère automatiquement ces distinctions comptables.", color: 'from-violet-400 to-purple-500' },
    { icon: Shield, title: 'Conformité RGPD et déontologie', description: "InvoiceAgent traite uniquement les données comptables. Aucune donnée confidentielle client n'est collectée. Hébergement Frankfurt (UE).", color: 'from-emerald-400 to-teal-500' },
    { icon: Clock, title: 'Réconciliation bancaire CSV', description: "Importez votre relevé bancaire CSV. L'IA rapproche automatiquement les virements clients avec les honoraires facturés.", color: 'from-blue-400 to-indigo-500' },
    { icon: BookOpen, title: 'Analyse de contrats', description: "Uploadez vos conventions d'honoraires ou contrats fournisseurs. L'IA identifie les clauses à risque, frais cachés et conditions abusives.", color: 'from-pink-400 to-rose-500' },
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16 lg:mb-20">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 mb-6">
            ...
            <span className="bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-transparent"> gérer votre cabinet sereinement</span>
          </h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Une suite complète d'outils conçue pour les avocats libéraux et les cabinets d'avocats français.
          </p>
        </AnimatedSection>
...
function HowItWorks() {
  const steps = [
    { number: '01', title: 'Importez vos factures', description: "Glissez vos factures fournisseurs PDF ou photographiez-les depuis votre smartphone. L'analyse démarre automatiquement.", icon: FileText },
    { number: '02', title: "L'IA extrait les données", description: 'En moins de 5 secondes, fournisseur, SIRET, montants HT/TTC, TVA et date d\'échéance sont extraits avec 98% de précision.', icon: Zap },
    { number: '03', title: 'Vérifiez et validez', description: 'Contrôlez les données extraites, corrigez si nécessaire et enregistrez en un clic. Les doublons sont détectés automatiquement.', icon: CheckCircle2 },
            ...
            <AnimatedSection key={index}>
              <div className="relative text-center group">
                <div className="relative mb-6">
                  ...
                  <div className="absolute -top-2 -right-2 w-8 h-8 rounded-full bg-white shadow-lg flex items-center justify-center mx-auto" style={{ left: '50%', transform: 'translateX(16px)' }}>
  ...
  const plans = [
    {
      ...
      features: ['5 factures fournisseurs/mois', 'Scan via smartphone (OCR)', 'Suivi payé / impayé', 'Tableau de bord simple', 'Export PDF'],
    ...
    },
    {
      name: 'Starter',
      price: '19',
      description: 'Pour cabinets individuels',
      features: ['100 factures / mois', 'Calcul TVA automatique', 'Réconciliation bancaire CSV', 'Alertes factures impayées', 'Export CSV + PDF', 'Tableau de bord complet'],
      cta: 'Choisir Starter',
      popular: true,
    ...
    },
    {
      ...
      features: ['Factures illimitées', 'IA correspondances bancaires', 'Export FEC conforme DGFiP', 'Analyse conventions honoraires', 'Détection clauses à risque', 'Frais cachés identifiés'],
      cta: 'Choisir Pro',
      popular: false,
    ...
    },
    {
      name: 'Business',
      price: '49',
      description: 'Cabinets multi-associés',
      features: ['Tout Pro inclus', 'Multi-établissements', 'Analyse contrats illimitée', 'Résumé intelligent', 'Historique sécurisé RGPD', 'Accompagnement personnalisé'],
    ...
    <section id="tarifs" className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16 lg:mb-20">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 mb-6">
            Des prix
            <span className="bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-transparent"> transparents</span>
          </h2>
...
function FAQ() {
  const faqs = [
    { q: "Les avocats sont-ils soumis à la TVA ?", a: "Oui. Les honoraires d'avocat sont soumis à la TVA au taux normal de 20%, sauf certaines missions d'aide juridictionnelle qui en sont exonérées. InvoiceAgent gère automatiquement ces distinctions et extrait le bon taux de TVA de chaque facture." },
    { q: "Comment gérer les honoraires et les débours ?", a: "InvoiceAgent extrait et classe automatiquement les honoraires, les débours et les frais refacturables. Chaque dépense est catégorisée selon les règles comptables spécifiques aux cabinets d'avocats." },
    { q: "InvoiceAgent est-il conforme aux règles déontologiques ?", a: "InvoiceAgent traite uniquement les données comptables — factures fournisseurs, relevés bancaires, contrats. Aucune donnée confidentielle client n'est jamais collectée ou traitée. Hébergement à Frankfurt (UE), conformité RGPD totale." },
    ...
    { q: "InvoiceAgent fonctionne-t-il pour les cabinets multi-associés ?", a: "Oui, dès le plan Business à 49€/mois. InvoiceAgent gère les structures multi-associés (SCP, SEL, AARPI) avec FEC séparé par entité et tableaux de bord consolidés." },
  ];
    ...
    <section id="faq" className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 mb-6">
            Questions
            <span className="bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-transparent"> fréquentes</span>
          </h2>
        </AnimatedSection>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <AnimatedSection>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">
            Automatisez la facturation de votre cabinet
          </h2>
...
// Main Page
export default function FacturationAvocat() {
  return (
    <>
