...
export default function PageComponent() {
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      <Navigation />
      <Hero title="Vous perdez de l argent sur vos factures sans le savoir" desc="31 800 euros perdus par an en moyenne. InvoiceAgent detecte doublons, frais caches et TVA incorrecte en 5 secondes. Essai gratuit." cta="Detecter mes pertes" />
      <Demo title="Detectez vos pertes sur factures maintenant" />
      <Pricing />
      ...
      <CTA title="Arretez de perdre de l argent sur vos factures" cta="Detecter mes pertes" />
      <SharedFooter />
    </div>
  );
}
