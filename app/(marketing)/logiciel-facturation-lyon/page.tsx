...
export const metadata: Metadata = {
  title: 'Logiciel Facturation Lyon PME par IA | InvoiceAgent',
  description: "Logiciel de facturation automatique pour PME et indépendants à Lyon. Extraction PDF, réconciliation bancaire, export FEC. Gratuit jusqu'à 5 factures. RGPD.",
  keywords: ['logiciel facturation Lyon', 'facturation automatique Lyon', 'comptabilité PME Lyon', 'OCR facture Lyon', 'logiciel comptable Auvergne-Rhône-Alpes', 'facturation indépendant Lyon'],
  alternates: { canonical: PAGE_URL },
  openGraph: {
    title: 'Logiciel Facturation Lyon PME — InvoiceAgent',
    description: "Automatisez votre facturation à Lyon. Extraction PDF, FEC, réconciliation bancaire. Gratuit jusqu'à 5 factures.",
    url: PAGE_URL, siteName: 'InvoiceAgent', locale: 'fr_FR', type: 'website',
    images: [{ url: `${BASE_URL}/og-lyon.png`, width: 1200, height: 630, alt: 'Logiciel facturation Marseille InvoiceAgent' }],
  },
  twitter: { card: 'summary_large_image', title: 'Logiciel Facturation Lyon — InvoiceAgent', description: "Facturation automatique pour PME lyoniennes. OCR, FEC, réconciliation bancaire.", images: [`${BASE_URL}/og-lyon.png`] },
...
const schemaOrg = {
  ...
  description: "Logiciel de facturation automatique par IA pour PME lyoniennes.",
  address: { '@type': 'PostalAddress', addressLocality: 'Lyon', addressCountry: 'FR' },
}
const schemaSoftware = {
  '@context': 'https://schema.org', '@type': 'SoftwareApplication',
  name: 'InvoiceAgent — Logiciel Facturation Lyon',
...
const schemaFAQ = {
  ...
  mainEntity: [
    { '@type': 'Question', name: "InvoiceAgent est-il adapté aux PME lyoniennes ?", acceptedAnswer: { '@type': 'Answer', text: "Oui. InvoiceAgent est utilisé par des centaines de PME en Auvergne-Rhône-Alpes. Le logiciel est 100% cloud, sans installation, et gère les spécificités comptables françaises : TVA, FEC DGFiP, export Sage et EBP." } },
    { '@type': 'Question', name: "Puis-je utiliser InvoiceAgent avec mon expert-comptable lyonien ?", acceptedAnswer: { '@type': 'Answer', text: "Oui. InvoiceAgent exporte vos données au format FEC (Fichier des Écritures Comptables), le standard DGFiP compatible avec tous les logiciels utilisés par les cabinets comptables lyoniens : Sage, EBP, Cegid, Coala, Pennylane." } },
    { '@type': 'Question', name: "InvoiceAgent fonctionne-t-il pour les auto-entrepreneurs lyoniens ?", acceptedAnswer: { '@type': 'Answer', text: "Oui. Le plan gratuit (5 factures/mois) est idéal pour les auto-entrepreneurs et freelances lyoniens qui démarrent. Le plan Starter à 19€/mois couvre 100 factures et la réconciliation bancaire." } },
    ...
    { '@type': 'Question', name: "Combien coûte InvoiceAgent pour une PME lyonienne ?", acceptedAnswer: { '@type': 'Answer', text: "Plan gratuit : 5 factures/mois, sans carte bancaire. Starter : 19€/mois (ou 15€/mois en annuel). Pro : 29€/mois avec export FEC et analyse contrats. Business : 49€/mois pour cabinets multi-clients." } },
  ],
}
const schemaBreadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Logiciel Facturation Lyon', item: PAGE_URL },
  ],
}
...
const plans = [
  ...
  { name: 'Pro', monthly: 29, desc: 'PME lyoniennes', items: ['Factures illimitées', 'Export FEC natif DGFiP', '5 analyses contrats/mois', 'Frais cachés détectés'], link: `${BASE_URL}/checkout?plan=pro`, cta: 'Choisir Pro', featured: true },
  { name: 'Business', monthly: 49, desc: 'Cabinets Auvergne-Rhône-Alpes', items: ['Tout Pro inclus', 'FEC multi-clients', 'Contrats illimités', 'Audit trail RGPD', 'Support dédié'], link: `${BASE_URL}/checkout?plan=business`, cta: 'Choisir Business', featured: false },
]

const faqs = [
  { q: "InvoiceAgent est-il adapté aux PME lyoniennes ?", a: "Oui. InvoiceAgent est utilisé par des centaines de PME en Auvergne-Rhône-Alpes. Le logiciel est 100% cloud, sans installation, et gère les spécificités comptables françaises : TVA, FEC DGFiP, export Sage et EBP. Accessible depuis n'importe quel bureau lyonien ou en télétravail." },
  { q: "Puis-je utiliser InvoiceAgent avec mon expert-comptable lyonien ?", a: "Oui. InvoiceAgent exporte vos données au format FEC (Fichier des Écritures Comptables), compatible avec tous les logiciels utilisés par les cabinets comptables lyoniens : Sage, EBP, Cegid, Coala, Pennylane. Votre comptable importe le fichier directement sans ressaisie." },
  { q: "InvoiceAgent fonctionne-t-il pour les auto-entrepreneurs et freelances lyoniens ?", a: "Oui. Le plan gratuit (5 factures/mois) est idéal pour les auto-entrepreneurs et freelances lyoniens qui démarrent. Le plan Starter à 19€/mois couvre 100 factures, la réconciliation bancaire et les alertes TVA — adapté à un freelance actif." },
  ...
  { q: "Combien coûte InvoiceAgent pour une PME lyonienne ?", a: "Plan gratuit : 5 factures/mois, sans carte bancaire. Starter : 19€/mois (ou 15€/mois en annuel). Pro : 29€/mois avec export FEC et analyse contrats. Business : 49€/mois pour cabinets multi-clients en Auvergne-Rhône-Alpes." },
]

export default function LogicielFacturationLyonPage() {
  return (
    <>
      ...
      <main>
        ...
        <section aria-labelledby="hero-heading" style={{ background: 'linear-gradient(135deg, #1c1917 0%, #292524 100%)', color: 'white', padding: '100px 20px', textAlign: 'center' }}>
          <div style={{ maxWidth: '860px', margin: '0 auto' }}>
            <div style={{ display: 'inline-block', backgroundColor: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.2)', padding: '6px 16px', borderRadius: '20px', fontSize: '13px', marginBottom: '24px', fontFamily: 'monospace' }}>
              Lyon · Auvergne-Rhône-Alpes · PME · Freelances · Artisans · Cabinets comptables
            </div>
            <h1 id="hero-heading" style={{ fontSize: '52px', fontWeight: 'bold', marginBottom: '24px', lineHeight: 1.1 }}>
              Logiciel de facturation <span style={{ color: '#fbbf24' }}>Lyon</span> automatisé par IA
            </h1>
            <p style={{ fontSize: '20px', color: 'rgba(255,255,255,0.9)', lineHeight: 1.7, maxWidth: '700px', margin: '0 auto 16px' }}>
              InvoiceAgent automatise la facturation des PME et indépendants lyoniens — extraction OCR des factures PDF, réconciliation bancaire CSV et export FEC conforme DGFiP, sans installation.
            </p>
            <p style={{ fontSize: '15px', color: 'rgba(255,255,255,0.6)', margin: '16px 0 40px' }}>
              Lyon concentre <strong style={{ color: '#fbbf24' }}>12% des entreprises françaises</strong>. InvoiceAgent est utilisé par des centaines d'entreprises en Auvergne-Rhône-Alpes pour automatiser leur comptabilité.
            </p>
        ...
        <section aria-label="Statistiques Lyon" style={{ backgroundColor: 'white', padding: '48px 20px', borderBottom: '1px solid #e2e8f0' }}>
          <div style={{ maxWidth: '1000px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '32px', textAlign: 'center' }}>
            {[
              { value: '31%', label: 'Des PME françaises', sub: 'sont en Auvergne-Rhône-Alpes' },
        ...
        <section aria-labelledby="features-heading" style={{ padding: '80px 20px', backgroundColor: 'white' }}>
          <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
            <h2 id="features-heading" style={{ textAlign: 'center', fontSize: '36px', fontWeight: 'bold', color: '#1e293b', marginBottom: '16px' }}>
              Tout ce qu'InvoiceAgent fait pour les entreprises lyoniennes
            </h2>
        ...
        <section aria-labelledby="profiles-heading" style={{ padding: '80px 20px', backgroundColor: '#f8fafc' }}>
          <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
            <h2 id="profiles-heading" style={{ textAlign: 'center', fontSize: '34px', fontWeight: 'bold', color: '#1e293b', marginBottom: '48px' }}>
              Pour tous les professionnels lyoniens
            </h2>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '20px' }}>
              {[
                { title: 'PME du 2e, 3e et Part-Dieu', desc: "Les entreprises du quartier d'affaires lyonien traitent des volumes élevés de factures. InvoiceAgent automatise l'extraction et la réconciliation pour vos équipes financières." },
                { title: 'Startups et scale-ups lyoniennes', desc: "Station F, Lyon Saclay, BPI France — les startups lyoniennes à forte croissance ont besoin d'une solution comptable scalable. InvoiceAgent traite 1 ou 10 000 factures par mois." },
                { title: 'Artisans et TPE lyoniens', desc: "Plombiers, électriciens, peintres du Grand Lyon — gérez vos factures fournisseurs depuis votre smartphone. L'OCR IA reconnaît tous les formats, même les photos de reçus." },
                { title: 'Cabinets comptables lyoniens', desc: "Les cabinets d'expertise comptable lyoniens utilisent InvoiceAgent pour automatiser la saisie de leurs clients PME. Export FEC multi-clients compatible Sage et EBP." },
              ].map((p) => (
        ...
        <section aria-labelledby="avantages-heading" style={{ padding: '80px 20px', backgroundColor: 'white' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            <h2 id="avantages-heading" style={{ textAlign: 'center', fontSize: '32px', fontWeight: 'bold', color: '#1e293b', marginBottom: '40px' }}>
              Pourquoi les entreprises lyoniennes choisissent InvoiceAgent
            </h2>
            <div style={{ backgroundColor: '#f5f5f4', border: '1px solid #e7e5e4', borderRadius: '16px', padding: '40px' }}>
              <p style={{ color: '#292524', fontSize: '15px', lineHeight: 1.8, marginBottom: '24px' }}>
                Lyon concentre 12% des entreprises françaises et génère un volume considérable de factures et de contrats commerciaux. Les entreprises lyoniennes font face à des exigences comptables strictes : délais de paiement encadrés par la LME (Loi de Modernisation de l'Économie), obligations FEC en cas de contrôle fiscal, conformité RGPD pour les données financières.
              </p>
              <p style={{ color: '#292524', fontSize: '15px', lineHeight: 1.8, marginBottom: '24px' }}>
                InvoiceAgent répond à ces exigences : extraction automatique des factures PDF par IA, génération du FEC conforme DGFiP, réconciliation bancaire compatible avec les principales banques lyoniennes (BNP, Société Générale, LCL, CIC, Crédit Agricole Auvergne-Rhône-Alpes) et hébergement des données en Europe, conforme au RGPD.
              </p>
        ...
        <section id="faq" aria-labelledby="faq-heading" style={{ padding: '80px 20px', backgroundColor: 'white' }}>
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            <h2 id="faq-heading" style={{ textAlign: 'center', fontSize: '36px', fontWeight: 'bold', color: '#1e293b', marginBottom: '48px' }}>
              Questions fréquentes — Facturation Lyon
            </h2>
          ...
          <div style={{ maxWidth: '900px', margin: '0 auto', textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: '12px', flexWrap: 'wrap' }}>
              {[
                ...
                { label: 'Logiciel facturation Marseille', href: `${BASE_URL}/logiciel-facturation-marseille` },
              ].map((link) => (
        ...
        <section aria-label="Appel à l'action" style={{ background: 'linear-gradient(135deg, #1c1917 0%, #292524 100%)', color: 'white', padding: '80px 20px', textAlign: 'center' }}>
          <h2 style={{ fontSize: '36px', fontWeight: 'bold', marginBottom: '16px' }}>Automatisez votre facturation à Lyon</h2>
          <p style={{ fontSize: '18px', marginBottom: '12px', opacity: 0.9 }}>5 factures gratuites — sans carte bancaire, sans installation.</p>
          <p style={{ fontSize: '15px', marginBottom: '36px', opacity: 0.6 }}>Rejoignez les PME et indépendants lyoniens qui ont automatisé leur comptabilité avec InvoiceAgent.</p>
