...
export default function PageComponent() {
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      <Navigation />
      <Hero title="Comment analyser un contrat fournisseur avant de signer" desc="Frais caches, resiliation couteuse, clauses desequilibrees — InvoiceAgent analyse votre contrat PDF en 30 secondes et identifie chaque risque." cta="Analyser mon contrat" />
      <Demo title="Analysez votre contrat fournisseur maintenant" />
      <Pricing />
      ...
      <CTA title="Analysez votre contrat avant de signer" cta="Analyser mon contrat" />
      <SharedFooter />
    </div>
  );
}
