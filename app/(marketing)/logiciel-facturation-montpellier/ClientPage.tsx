...
const schemaSoftware = { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: 'InvoiceAgent — Logiciel Facturation Montpellier', applicationCategory: 'BusinessApplication', operatingSystem: 'Web, SaaS', url: PAGE_URL, offers: { '@type': 'AggregateOffer', lowPrice: '0', highPrice: '49', priceCurrency: 'EUR' }, aggregateRating: { '@type': 'AggregateRating', ratingValue: '4.8', reviewCount: '27' } };
const schemaFAQ = {
  '@context': 'https://schema.org', '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: "Quel logiciel de facturation pour les entreprises à Montpellier ?", acceptedAnswer: { '@type': 'Answer', text: "InvoiceAgent est un logiciel de facturation IA pour les artisans, PME et freelances de Montpellier et Hérault. Automatise l'extraction des factures par OCR IA, gère la TVA et génère le FEC conforme DGFiP. Gratuit jusqu'à 5 factures/mois." } },
    { '@type': 'Question', name: "Comment gérer ses factures fournisseurs à Montpellier ?", acceptedAnswer: { '@type': 'Answer', text: "Photographiez vos factures Point P Montpellier avec votre smartphone. InvoiceAgent extrait fournisseur, montants HT/TTC et TVA en moins de 5 secondes par OCR IA." } },
    { '@type': 'Question', name: "InvoiceAgent fonctionne-t-il pour les artisans de Hérault ?", acceptedAnswer: { '@type': 'Answer', text: "Oui. Accessible depuis smartphone ou ordinateur, sans installation. Les artisans de Hérault scannent leurs factures depuis le chantier et exportent leur FEC pour leur comptable local." } },
  ],
};
const schemaBreadcrumb = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Accueil', item: BASE_URL }, { '@type': 'ListItem', position: 2, name: 'Logiciel Facturation Montpellier', item: PAGE_URL }] };
const schemaLocal = { '@context': 'https://schema.org', '@type': 'LocalBusiness', name: 'InvoiceAgent — Montpellier', url: PAGE_URL, description: 'Logiciel de facturation IA pour artisans et PME à Montpellier', areaServed: { '@type': 'City', name: 'Montpellier' } };
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="text-center lg:text-left">
            <motion.div variants={fadeInUp}>
              <Badge className="mb-6 px-4 py-2 bg-violet-100 text-violet-700 border-0 text-sm font-medium">
                <MapPin className="w-4 h-4 mr-2" />Logiciel de facturation pour artisans et PME à Montpellier
              </Badge>
            </motion.div>
            <motion.h1 variants={fadeInUp} className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              ...
              <span className="bg-gradient-to-r from-violet-600 via-indigo-600 to-violet-600 bg-clip-text text-transparent">Montpellier</span><br />
            ...
            <motion.p variants={fadeInUp} className="text-lg sm:text-xl text-slate-600 mb-6 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Plus de <strong>11,200 artisans et 8,600 PME</strong> en Hérault gèrent des dizaines de factures fournisseurs chaque mois. InvoiceAgent les traite automatiquement par OCR IA — depuis n'importe quel chantier ou bureau à Montpellier.
            </motion.p>
            <motion.div variants={fadeInUp} className="grid grid-cols-3 gap-3 mb-8">
              {[{ value: '11,200', label: 'Artisans', sub: 'en Hérault' }, { value: '< 5s', label: 'Par facture', sub: 'OCR IA auto' }, { value: '€0', label: 'Pour démarrer', sub: '5 factures/mois' }].map((stat) => (
            ...
            <motion.div variants={fadeInUp} className="bg-indigo-50 border border-indigo-100 rounded-xl p-4 mb-6 text-left">
              <p className="text-sm text-indigo-700 leading-relaxed"><span className="font-semibold">📍 Montpellier :</span> Métropole en forte croissance, Montpellier voit des centaines de chantiers ouverts chaque mois — résidentiel neuf, rénovation de mas languedociens, projets tertiaires. Les artisans de l'Hérault gèrent en moyenne 40 à 60 factures fournisseurs par mois.</p>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="flex flex-wrap items-center justify-center lg:justify-start gap-6 text-sm text-slate-500">
              {["Gratuit jusqu'à 5 factures/mois", "Point P Montpellier reconnu auto", "Contrats analysés par IA"].map((item) => (
          ...
          <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 1, delay: 0.3 }} className="relative">
            <div className="bg-white rounded-3xl shadow-2xl shadow-violet-600/20 p-6 border border-slate-100">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div><p className="font-semibold text-slate-900">Artisan — Montpellier</p><p className="text-sm text-slate-500">Hérault</p></div>
                </div>
              ...
              <div className="space-y-3">
                {[{ client: 'Point P Montpellier — Matériaux chantier', amount: '€3,840', status: 'Payée' }, { client: 'Fournisseur local Montpellier', amount: '€1,280', status: 'En attente' }, { client: 'Point P Montpellier — Béton', amount: '€2,120', status: 'Payée' }].map((item, i) => (
            ...
            <motion.div animate={{ y: [0, 10, 0] }} transition={{ duration: 4, repeat: Infinity, ease: 'easeInOut', delay: 0.5 }} className="absolute -bottom-4 -left-4 bg-white rounded-2xl shadow-xl p-4 border border-slate-100">
              <div className="flex items-center gap-2"><MapPin className="w-5 h-5 text-violet-500" /><span className="text-sm font-medium text-slate-900">Montpellier</span><span className="text-xs text-slate-500">34000</span></div>
            </motion.div>
          </motion.div>
        </div>
      </motion.div>
...
function Features() {
  const features = [
    { icon: Zap, title: `OCR factures fournisseurs — Montpellier`, description: `Scannez vos factures Point P Montpellier, BigMat depuis le chantier. Fournisseur, montants HT/TTC, TVA extraits en moins de 5 secondes par OCR IA.`, color: 'from-amber-400 to-orange-500' },
    ...
    { icon: Calculator, title: 'Export FEC conforme DGFiP', description: "Générez votre FEC en un clic. Compatible Sage, EBP, Cegid. Votre expert-comptable de Montpellier reçoit un fichier structuré.", color: 'from-cyan-400 to-blue-500' },
  ];
  return (
    <section id="features" className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 mb-6">Application facturation <span className="bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-transparent">Montpellier</span> complète</h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">InvoiceAgent gère les factures fournisseurs et les contrats — les deux besoins essentiels des artisans et PME de Montpellier et Hérault.</p>
        </AnimatedSection>
...
function Pricing() {
  const plans = [
    { name: 'Gratuit', price: '0', description: 'Pour démarrer à Montpellier', features: ['5 factures fournisseurs/mois', 'Scan smartphone chantier', 'Suivi payé / impayé', 'Tableau de bord simple', 'Export PDF'], cta: 'Commencer gratuitement', popular: false, href: `${BASE_URL}/auth/login` },
    { name: 'Starter', price: '19', description: 'Artisans et PME de Hérault', features: ['100 factures / mois', 'TVA 10% et 20% automatique', 'Réconciliation bancaire CSV', 'Alertes factures impayées', 'Export CSV + PDF', 'Tableau de bord complet'], cta: 'Choisir Starter', popular: true, href: `${BASE_URL}/checkout?plan=starter` },
    ...
    { name: 'Business', price: '49', description: 'Multi-chantiers Montpellier', features: ['Tout Pro inclus', 'Multi-chantiers illimité', 'Analyse contrats illimitée', 'Résumé intelligent', 'Historique RGPD', 'Accompagnement perso'], cta: 'Choisir Business', popular: false, href: `${BASE_URL}/checkout?plan=business` },
  ];
  return (
    ...
    <section id="demo" className="py-24 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Testez le logiciel de facturation pour Montpellier</h2>
        ...
        <div className="grid grid-cols-3 gap-6 mt-10">
          {[{ value: '11,200', label: 'Artisans en Hérault', icon: MapPin }, { value: '< 5s', label: 'Par facture traitée', icon: Zap }, { value: '€0', label: 'Pour commencer', icon: CheckCircle2 }].map((stat) => (
...
function FAQ() {
  const faqs = [
    { q: "Quel logiciel de facturation pour les entreprises à Montpellier ?", a: "InvoiceAgent est un logiciel de facturation IA pour les artisans, PME et freelances de Montpellier et Hérault. Il automatise l'extraction des factures fournisseurs par OCR, gère la TVA 10% et 20% et génère le FEC conforme DGFiP. Gratuit jusqu'à 5 factures par mois — sans installation." },
    { q: "Comment gérer ses factures fournisseurs à Montpellier ?", a: "Photographiez vos factures Point P Montpellier, BigMat avec votre smartphone depuis le chantier. InvoiceAgent extrait automatiquement le fournisseur, les montants HT/TTC et la TVA en moins de 5 secondes par OCR IA." },
    { q: "InvoiceAgent fonctionne-t-il pour les artisans de Hérault ?", a: "Oui. InvoiceAgent est accessible depuis n'importe quel smartphone ou ordinateur, sans installation. Les artisans de Hérault peuvent scanner leurs factures depuis le chantier et exporter leur FEC pour leur comptable local à Montpellier." },
    { q: "Quel expert-comptable à Montpellier peut importer les exports InvoiceAgent ?", a: "Les exports FEC d'InvoiceAgent sont compatibles avec Sage 100, Cegid Expert et EBP — utilisés par la grande majorité des experts-comptables à Montpellier et en Occitanie. Import direct sans ressaisie." },
    { q: "Puis-je utiliser InvoiceAgent depuis un chantier à Montpellier ?", a: "Oui. L'interface est optimisée pour smartphone. Photographiez une facture depuis n'importe quel chantier en Hérault — l'IA extrait les données en moins de 5 secondes, même en mauvaise lumière." },
  ];
  ...
  return (
    <section className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <AnimatedSection>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">Le logiciel de facturation des artisans et PME de Montpellier</h2>
          <p className="text-lg text-violet-100 mb-4 max-w-2xl mx-auto">5 factures gratuites — sans carte bancaire, sans installation. Opérationnel depuis Montpellier en 2 minutes.</p>
...
function InternalLinks() {
  const links = [
    ...
    { label: 'Logiciel facturation proche', href: `${BASE_URL}/logiciel-facturation-nimes` },
  ];
  return (
...
export default function LogicielFacturationMontpellier() {
  return (
    <>
