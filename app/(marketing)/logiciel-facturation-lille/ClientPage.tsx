...
const schemaSoftware = {
  ...
  name: 'InvoiceAgent — Logiciel Facturation Lille',
...
const schemaFAQ = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: "Quel logiciel de facturation pour les entreprises à Lille ?",
      acceptedAnswer: { '@type': 'Answer', text: "InvoiceAgent est un logiciel de facturation IA pour les artisans, PME et freelances de Lille et de Nord. Il automatise l'extraction des factures fournisseurs par OCR, gère la TVA et génère le FEC conforme DGFiP. Gratuit jusqu'à 5 factures par mois." }
    },
    {
      '@type': 'Question',
      name: "Comment gérer ses factures fournisseurs à Lille ?",
      acceptedAnswer: { '@type': 'Answer', text: "InvoiceAgent extrait automatiquement les factures de vos fournisseurs locaux à Lille — Espace Emeraude, Point P Lille et autres. Chaque facture est traitée en moins de 5 secondes par OCR IA depuis votre smartphone." }
    },
    {
      '@type': 'Question',
      name: "InvoiceAgent fonctionne-t-il pour les artisans de Nord ?",
      acceptedAnswer: { '@type': 'Answer', text: "Oui. InvoiceAgent est utilisé par des artisans, freelances et PME partout en France, dont Lille et Nord. Accessible depuis n'importe quel smartphone ou ordinateur, sans installation." }
    },
  ],
};
const schemaBreadcrumb = {
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Logiciel Facturation Lille', item: PAGE_URL }
  ]
};
const schemaLocal = {
  '@context': 'https://schema.org', '@type': 'LocalBusiness',
  name: 'InvoiceAgent — Lille',
  url: PAGE_URL,
  description: 'Logiciel de facturation IA pour artisans et PME à Lille',
          ...
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="text-center lg:text-left">
            <motion.div variants={fadeInUp}>
              <Badge className="mb-6 px-4 py-2 bg-violet-100 text-violet-700 hover:bg-violet-200 border-0 text-sm font-medium">
                ...
                Logiciel de facturation pour artisans et PME à Lille
              </Badge>
            </motion.div>
            <motion.h1 variants={fadeInUp} className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              ...
              <br />
              <span className="bg-gradient-to-r from-violet-600 via-indigo-600 to-violet-600 bg-clip-text text-transparent">Lille</span>
              <br />
            ...
            <motion.p variants={fadeInUp} className="text-lg sm:text-xl text-slate-600 mb-6 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Plus de <strong>15,800 artisans et 11,400 PME</strong> en Nord gèrent des dizaines de factures fournisseurs chaque mois. InvoiceAgent les traite automatiquement par OCR IA — depuis n'importe quel chantier ou bureau à Lille.
            </motion.p>
            <motion.div variants={fadeInUp} className="grid grid-cols-3 gap-3 mb-8">
              {[
                { value: '15,800', label: 'Artisans', sub: 'en Nord' },
            ...
            <motion.div variants={fadeInUp} className="flex flex-wrap items-center justify-center lg:justify-start gap-6 text-sm text-slate-500">
              {["Gratuit jusqu'à 5 factures/mois", `Espace Emeraude, Point P Lille reconnus auto`, 'Contrats analysés par IA'].map((item) => (
          ...
          <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 1, delay: 0.3 }} className="relative">
            <div className="bg-white rounded-3xl shadow-2xl shadow-violet-600/20 p-6 border border-slate-100">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-slate-900">Artisan — Lille</p>
                    <p className="text-sm text-slate-500">Nord</p>
                  </div>
                </div>
              ...
              <div className="space-y-3">
                {[
                  { client: 'Espace Emeraude, Point P Lille — Matériaux chantier', amount: '€3,840', status: 'Payée' },
                  { client: 'Fournisseur local Lille — Outillage', amount: '€1,280', status: 'En attente' },
                  { client: 'Point P Lille — Matériaux', amount: '€2,120', status: 'Payée' },
                ].map((item, i) => (
            ...
            <motion.div animate={{ y: [0, 10, 0] }} transition={{ duration: 4, repeat: Infinity, ease: 'easeInOut', delay: 0.5 }} className="absolute -bottom-4 -left-4 bg-white rounded-2xl shadow-xl p-4 border border-slate-100">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-slate-900">Lille</span>
                <span className="text-xs text-slate-500">59000</span>
              </div>
            </motion.div>
          </motion.div>
        </div>
...
function Features() {
  const features = [
    { icon: Zap, title: `OCR factures fournisseurs — Lille`, description: `Scannez vos factures Espace Emeraude, Point P Lille et autres fournisseurs locaux de Lille depuis votre chantier. Chaque facture est extraite en moins de 5 secondes par OCR IA — montants HT/TTC, TVA, SIRET automatiques.`, color: 'from-amber-400 to-orange-500' },
    ...
    { icon: Calculator, title: 'Export FEC conforme DGFiP', description: "Générez votre FEC en un clic. Compatible Sage, EBP, Cegid. Votre expert-comptable de Lille reçoit un fichier structuré — sans ressaisie manuelle.", color: 'from-cyan-400 to-blue-500' },
  ];
  return (
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16 lg:mb-20">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 mb-6">
            Application facturation <span className="bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-transparent">Lille</span> complète
          </h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">InvoiceAgent gère les factures fournisseurs et les contrats — les deux besoins essentiels des artisans et PME de Lille et Nord.</p>
        </AnimatedSection>
...
function Pricing() {
  const plans = [
    { name: 'Gratuit', price: '0', description: 'Pour démarrer à Lille', features: ['5 factures fournisseurs/mois', 'Scan smartphone chantier (OCR)', 'Suivi payé / impayé', 'Tableau de bord simple', 'Export PDF'], cta: 'Commencer gratuitement', popular: false, href: `${BASE_URL}/auth/login` },
    { name: 'Starter', price: '19', description: 'Artisans et PME de Nord', features: ['100 factures / mois', 'TVA 10% et 20% automatique', 'Réconciliation bancaire CSV', 'Alertes factures impayées', 'Export CSV + PDF', 'Tableau de bord complet'], cta: 'Choisir Starter', popular: true, href: `${BASE_URL}/checkout?plan=starter` },
    ...
    { name: 'Business', price: '49', description: 'Entreprises multi-chantiers Lille', features: ['Tout Pro inclus', 'Multi-chantiers illimité', 'Analyse contrats illimitée', 'Résumé intelligent', 'Historique sécurisé RGPD', 'Accompagnement personnalisé'], cta: 'Choisir Business', popular: false, href: `${BASE_URL}/checkout?plan=business` },
  ];
  return (
    ...
    <section id="demo" className="py-24 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Testez le logiciel de facturation pour Lille</h2>
        ...
        <div className="grid grid-cols-3 gap-6 mt-10">
          {[{ value: '15,800', label: 'Artisans en Nord', icon: MapPin }, { value: '< 5s', label: 'Par facture traitée', icon: Zap }, { value: '€0', label: 'Pour commencer', icon: CheckCircle2 }].map((stat) => (
...
function FAQ() {
  const faqs = [
    { q: "Quel logiciel de facturation pour les entreprises à Lille ?", a: "InvoiceAgent est un logiciel de facturation IA utilisé par les artisans, PME et freelances de Lille et Nord. Il automatise l'extraction des factures fournisseurs par OCR, gère la TVA 10% et 20% selon le type de chantier, et génère le FEC conforme DGFiP. Gratuit jusqu'à 5 factures par mois — sans installation." },
    { q: "Comment gérer ses factures fournisseurs à Lille ?", a: "Photographiez vos factures Espace Emeraude, Point P Lille et autres fournisseurs locaux de Lille avec votre smartphone depuis le chantier. InvoiceAgent extrait automatiquement le fournisseur, le SIRET, les montants HT/TTC et la TVA en moins de 5 secondes. Toutes les données sont stockées et classées automatiquement." },
    { q: "InvoiceAgent fonctionne-t-il pour les artisans de Nord ?", a: "Oui. InvoiceAgent est accessible depuis n'importe quel smartphone ou ordinateur, sans installation. Les artisans de Nord peuvent scanner leurs factures depuis le chantier, analyser leurs contrats avant signature et exporter leur FEC pour leur comptable local." },
    { q: "Quel expert-comptable à Lille peut importer les exports InvoiceAgent ?", a: "Les exports FEC d'InvoiceAgent sont compatibles avec Sage 100, Cegid Expert et EBP — les logiciels utilisés par la grande majorité des experts-comptables à Lille et en Hauts-de-France. Votre comptable peut importer directement sans ressaisie." },
    { q: "Puis-je utiliser InvoiceAgent depuis un chantier à Lille ?", a: "Oui. L'interface est entièrement optimisée pour smartphone. Photographiez une facture fournisseur depuis n'importe quel chantier à Lille ou Nord — l'IA extrait les données en moins de 5 secondes, même en mauvaise lumière." },
  ];
  ...
  return (
    <section className="py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <AnimatedSection>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">Le logiciel de facturation des artisans et PME de Lille</h2>
          <p className="text-lg sm:text-xl text-violet-100 mb-4 max-w-2xl mx-auto">5 factures gratuites — sans carte bancaire, sans installation. Opérationnel depuis Lille en 2 minutes.</p>
...
export default function LogicielFacturationLille() {
  return (
    <>
