...
export default function PageComponent() {
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      <Navigation />
      <Hero title="Erreur TVA facture : comment corriger sans risque fiscal" desc="Une erreur TVA non corrigee entraine jusqu a 40% de majoration fiscale. InvoiceAgent detecte en 5 secondes et guide vers la correction." cta="Verifier mes factures" />
      <Demo title="Verifiez la TVA de vos factures maintenant" />
      <Pricing />
      ...
      <CTA title="Corrigez vos erreurs TVA avant le controle fiscal" cta="Verifier mes factures" />
      <SharedFooter />
    </div>
  );
}
