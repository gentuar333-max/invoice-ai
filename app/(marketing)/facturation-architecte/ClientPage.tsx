...
import { FileText, Zap, Shield, Clock, CheckCircle2, ArrowRight, ChevronDown, Sparkles, Building2, Ruler, Calculator, FileSearch, Map, HardHat } from 'lucide-react';
...
const PAGE_URL = `${BASE_URL}/facturation-architecte`;
...
const schemaSoftware = { '@context': 'https://schema.org', '@type': 'SoftwareApplication', name: "InvoiceAgent — Facturation Architecte", applicationCategory: 'BusinessApplication', operatingSystem: 'Web, SaaS', url: PAGE_URL, offers: { '@type': 'AggregateOffer', lowPrice: '0', highPrice: '49', priceCurrency: 'EUR' }, aggregateRating: { '@type': 'AggregateRating', ratingValue: '4.8', reviewCount: '51' } };
const schemaFAQ = {
  '@context': 'https://schema.org', '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: "Quel taux de TVA s'applique aux honoraires d'architecte ?", acceptedAnswer: { '@type': 'Answer', text: "Les honoraires d'architecte sont soumis à la TVA au taux normal de 20%. Certaines missions peuvent bénéficier du taux réduit de 10% pour les travaux de rénovation. InvoiceAgent gère automatiquement ces distinctions." } },
    { '@type': 'Question', name: "Comment gérer les notes d'honoraires et les situations de travaux ?", acceptedAnswer: { '@type': 'Answer', text: "InvoiceAgent extrait automatiquement les données des notes d'honoraires et les classe par mission. Les situations de travaux et les appels de fonds sont reconnus et associés au chantier correspondant." } },
    { '@type': 'Question', name: "InvoiceAgent est-il adapté aux agences d'architecture ?", acceptedAnswer: { '@type': 'Answer', text: "Oui. Le plan Business permet de gérer plusieurs projets et associés depuis un seul dashboard avec FEC séparé par entité." } },
...
const schemaBreadcrumb = { '@context': 'https://schema.org', '@type': 'BreadcrumbList', itemListElement: [{ '@type': 'ListItem', position: 1, name: 'Accueil', item: BASE_URL }, { '@type': 'ListItem', position: 2, name: 'Facturation Architecte', item: PAGE_URL }] };
          ...
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="text-center lg:text-left">
            <motion.div variants={fadeInUp}>
              <Badge className="mb-6 px-4 py-2 bg-violet-100 text-violet-700 hover:bg-violet-200 border-0 text-sm font-medium">
                ...
                Solution comptable pour architectes libéraux
              </Badge>
            </motion.div>
            <motion.h1 variants={fadeInUp} className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              <span className="bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent">Facturation architecte</span>
              <br />
            ...
            <motion.p variants={fadeInUp} className="text-lg sm:text-xl text-slate-600 mb-8 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Gérez les honoraires, notes de frais et factures fournisseurs de votre agence d'architecture automatiquement. InvoiceAgent extrait les données par OCR IA — TVA 20% et 10% gérées selon le type de mission.
            </motion.p>
          ...
          <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 1, delay: 0.3 }} className="relative">
            <div className="bg-white rounded-3xl shadow-2xl shadow-violet-600/20 p-6 border border-slate-100">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-slate-900">Agence d'architecture</p>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="bg-gradient-to-br from-violet-50 to-indigo-50 rounded-2xl p-4">
                  <p className="text-sm text-slate-500 mb-1">Honoraires/mois</p>
                  <p className="text-2xl font-bold text-slate-900">€38,200</p>
              ...
              <div className="space-y-3">
                {[
                  { client: 'Villa Dupont — Rénovation', amount: '€14,500', status: 'Payée' },
                  { client: 'Immeuble Martin — Neuf', amount: '€28,000', status: 'En attente' },
                  { client: 'Maison Bernard — Extension', amount: '€8,200', status: 'Payée' },
                ].map((item, i) => (
                  <motion.div key={i} initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.8 + i * 0.1 }} className="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500">Honoraires mission</p>
                      </div>
                    </div>
            ...
            <motion.div animate={{ y: [0, 10, 0] }} transition={{ duration: 4, repeat: Infinity, ease: 'easeInOut', delay: 0.5 }} className="absolute -bottom-4 -left-4 bg-white rounded-2xl shadow-xl p-4 border border-slate-100">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-slate-900">OCR &lt; 5 sec</span>
                <span className="text-xs text-slate-500">par facture</span>
              </div>
            </motion.div>
          </motion.div>
        </div>
...
function Features() {
  const features = [
    { icon: Zap, title: 'OCR factures fournisseurs', description: "Importez vos factures d'entreprises générales, bureaux d'études et prestataires. L'IA extrait fournisseur, SIRET, montants HT/TTC et TVA en moins de 5 secondes.", color: 'from-amber-400 to-orange-500' },
    { icon: Ruler, title: 'Gestion TVA missions architecte', description: "TVA 20% sur les honoraires de conception, 10% sur les missions de rénovation — InvoiceAgent applique automatiquement le bon taux selon la nature de votre mission.", color: 'from-violet-400 to-purple-500' },
    { icon: Shield, title: 'Conformité RGPD totale', description: "InvoiceAgent traite uniquement les données comptables. Aucune donnée confidentielle de vos maîtres d'ouvrage n'est collectée. Hébergement Frankfurt (UE).", color: 'from-emerald-400 to-teal-500' },
    { icon: Clock, title: 'Réconciliation bancaire CSV', description: "Importez votre relevé bancaire CSV. L'IA rapproche automatiquement les virements d'acomptes et de soldes avec les situations de travaux facturées.", color: 'from-blue-400 to-indigo-500' },
    { icon: Map, title: 'Suivi par chantier', description: "Classez automatiquement les factures fournisseurs par chantier. Suivez les dépenses de chaque mission en temps réel pour un suivi budgétaire précis.", color: 'from-pink-400 to-rose-500' },
    { icon: Calculator, title: 'Export FEC conforme DGFiP', description: "Générez votre FEC en un clic. Compatible Sage, EBP, Cegid et les logiciels utilisés par les experts-comptables spécialisés en professions libérales.", color: 'from-cyan-400 to-blue-500' },
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-16 lg:mb-20">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 mb-6">
            Conçu pour les
            <span className="bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-transparent"> architectes libéraux</span>
          </h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Une suite d'outils adaptée aux spécificités comptables des agences d'architecture françaises.
          </p>
        </AnimatedSection>
...
function HowItWorks() {
  const steps = [
    { number: '01', title: 'Importez vos factures', description: "Glissez vos factures fournisseurs PDF ou photographiez-les depuis le chantier. L'analyse démarre automatiquement.", icon: FileText },
    { number: '02', title: "L'IA extrait les données", description: "Fournisseur, SIRET, montants HT/TTC, TVA et date d'échéance extraits en moins de 5 secondes avec 98% de précision.", icon: Zap },
    { number: '03', title: 'Vérifiez et classez', description: "Contrôlez les données, associez chaque facture à son chantier et validez. Les doublons sont détectés automatiquement.", icon: CheckCircle2 },
    { number: '04', title: 'Exportez pour votre comptable', description: "Générez votre FEC conforme DGFiP ou exportez en CSV. Votre expert-comptable reçoit un fichier structuré et propre.", icon: Calculator },
  ];
...
function Pricing() {
  const plans = [
    ...
    { name: 'Starter', price: '19', description: 'Pour architectes indépendants', features: ['100 factures / mois', 'Calcul TVA automatique (10% et 20%)', 'Réconciliation bancaire CSV', 'Alertes factures impayées', 'Export CSV + PDF', 'Tableau de bord complet'], cta: 'Choisir Starter', popular: true, href: `${BASE_URL}/checkout?plan=starter` },
    { name: 'Pro', price: '29', description: 'Automatisation avancée', features: ['Factures illimitées', 'IA correspondances bancaires', 'Export FEC conforme DGFiP', 'Analyse contrats maîtrise ouvrage', 'Détection clauses à risque', 'Frais cachés identifiés'], cta: 'Choisir Pro', popular: false, href: `${BASE_URL}/checkout?plan=pro` },
    { name: 'Business', price: '49', description: 'Agences multi-associés', features: ['Tout Pro inclus', 'Multi-projets et multi-associés', 'Analyse contrats illimitée', 'Résumé intelligent', 'Historique sécurisé RGPD', 'Accompagnement personnalisé'], cta: 'Choisir Business', popular: false, href: `${BASE_URL}/checkout?plan=business` },
  ];
...
function FAQ() {
  const faqs = [
    { q: "Quel taux de TVA s'applique aux honoraires d'architecte ?", a: "Les honoraires d'architecte sont soumis au taux normal de TVA de 20% pour les missions sur constructions neuves et les études. Pour les missions de maîtrise d'œuvre sur des travaux de rénovation de logements de plus de 2 ans, le taux réduit de 10% peut s'appliquer. InvoiceAgent extrait automatiquement le taux de TVA mentionné sur chaque facture." },
    { q: "Comment gérer les notes d'honoraires et les situations de travaux ?", a: "InvoiceAgent extrait et classe automatiquement les notes d'honoraires, les situations de travaux et les appels de fonds. Chaque document est reconnu selon sa nature et associé au chantier correspondant. Les acomptes et soldes sont rapprochés automatiquement avec vos relevés bancaires." },
    { q: "InvoiceAgent est-il adapté aux agences d'architecture ?", a: "Oui. Le plan Business à 49€/mois permet de gérer plusieurs associés et plusieurs projets depuis un seul dashboard. Les FEC peuvent être générés par entité ou de façon consolidée pour l'ensemble de l'agence." },
    { q: "Comment exporter les données pour mon expert-comptable ?", a: "Export FEC natif compatible Sage, EBP et Cegid. Export CSV et PDF également disponibles. Votre expert-comptable spécialisé en professions libérales peut importer directement sans ressaisie." },
    { q: "InvoiceAgent fonctionne-t-il depuis le chantier ?", a: "Oui. L'interface est entièrement responsive. Photographiez une facture fournisseur depuis le chantier avec votre smartphone — l'IA extrait les données en quelques secondes, même en mauvaise qualité ou en angle." },
  ];
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <AnimatedSection>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">
            Automatisez la facturation de votre agence
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" className="border-2 border-white/30 text-white hover:bg-white/10 text-lg px-8 h-14" asChild>
              <a href={`${BASE_URL}/tarifs`}>Voir les tarifs</a>
            </Button>
          </div>
...
function InternalLinks() {
  const links = [
    ...
    { label: 'Facturation BTP', href: `${BASE_URL}/facturation-btp-construction` },
...
export default function FacturationArchitecte() {
  return (
    <>
