...
export default function PageComponent() {
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      <Navigation />
      <Hero title="Erreurs TVA artisan BTP : 10%, 5,5% ou 20%" desc="Un mauvais taux TVA sur un chantier coute des milliers d euros. InvoiceAgent verifie taux, CERFA et calculs en 5 secondes." cta="Verifier ma TVA" />
      <Demo title="Verifiez la TVA de vos factures artisan maintenant" />
      <Pricing />
      ...
      <CTA title="Ne laissez plus une erreur TVA vous couter cher" cta="Verifier ma TVA" />
      <SharedFooter />
    </div>
  );
}
