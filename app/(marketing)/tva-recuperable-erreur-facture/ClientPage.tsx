...
export default function PageComponent() {
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      <Navigation />
      <Hero title="TVA non recuperable : l erreur de facture qui vous coute cher" desc="6 200 euros de TVA perdue par an. InvoiceAgent verifie numero VIES, taux et mentions en 5 secondes avant comptabilisation." cta="Verifier ma TVA" />
      ...
      <CTA title="Ne perdez plus un euro de TVA sur une erreur de facture" cta="Verifier ma TVA" />
      <SharedFooter />
    </div>
  );
}
